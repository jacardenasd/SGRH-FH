...
// Lista de empleados con tipo_empleado_id = 1 para importar y generar contratos indeterminados
...
$sqlEmpleados = "SELECT empleado_id
                 FROM empleados 
...
$page_title = 'Importar Empleado para Contrato Indeterminado';
...
<div class="page-header page-header-light">
  <div class="page-header-content">
    <div class="page-title d-flex">
      <h4><i class="icon-users mr-2"></i> Seleccionar Empleado para Contrato Indeterminado</h4>
...
<div class="content">
  <div class="card">
    <div class="card-header">
      <h6 class="card-title">Empleados con Tipo: Determinado (Tipo 1)</h6>
      <p class="text-muted mb-0 small">Seleccione un empleado para generar su contrato indeterminado</p>
    </div>
    <div class="card-body">
        ...
        <div class="table-responsive">
          <table class="table datatable-basic">
            ...
            <tbody>
              ...
              <tr>
                <td><?php echo h($emp['empleado_id']); ?></td>
                <td>-</td>
                <td>-</td>
                <td>-</td>
                <td>-</td>
      ...
      <?php else: ?>
        <div class="alert alert-info">
          <i class="icon-info22 mr-2"></i>No se encontraron empleados con tipo "Determinado" (tipo_empleado_id = 1).
        </div>
      <?php endif; ?>
    </div>
  </div>
