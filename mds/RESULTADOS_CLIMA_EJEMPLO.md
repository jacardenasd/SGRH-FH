...
## Estructura: Empresa → Área/Unidad | Superdimensiones → Dimensiones

### 📊 Modelo Implementado

El sistema está organizado en **4 Superdimensiones** que agrupan **12 Dimensiones**:
...
3. **Agrupación**: Por Superdimensión y luego por Dimensión
...
- **Promedio Global**: 72.0%
- **Respondentes**: 150 personas
- **Escala**: 0-100

#### Desglose por Superdimensión:

| Superdimensión | Promedio | Estado |
|----------------|----------|--------|
| **Relación con el Jefe Inmediato** | 74.2% | ✅ Bueno |
| **Relación con los Compañeros** | 69.7% | ⚠️ Regular |
| **Relación con la Empresa** | 72.8% | ✅ Bueno |
| **Relación con el Trabajo** | 71.3% | ✅ Bueno |

#### Desglose por Dimensión (12 dimensiones):

**🔸 Relación con el Jefe Inmediato**
- Liderazgo inmediato: 75.5% ✅
- Reconocimiento: 72.8% ✅

**🔸 Relación con los Compañeros**
- Colaboración entre áreas: 68.5% ⚠️
- Comunicación interna: 70.2% ✅
- Equidad y respeto: 70.5% ✅

**🔸 Relación con la Empresa**
- Propósito y alineación: 74.0% ✅
- Estructura y coordinación: 71.5% ✅
- Recursos y herramientas: 69.8% ⚠️
- Bienestar y balance: 76.0% ✅

**🔸 Relación con el Trabajo**
- Claridad de rol: 73.2% ✅
- Desarrollo y aprendizaje: 71.0% ✅
- Procesos y eficiencia: 69.8% ⚠️

---

### MI ÁREA (Dirección de Operaciones) - Resultados Específicos
- **Promedio Global**: 65.0%
- **Respondentes**: 45 personas
- **Escala**: 0-100

#### Desglose por Superdimensión:

| Superdimensión | Promedio | Comparativa |
|----------------|----------|-------------|
| **Relación con el Jefe Inmediato** | 65.5% | ❌ -8.7% vs empresa |
| **Relación con los Compañeros** | 63.7% | ❌ -6.0% vs empresa |
| **Relación con la Empresa** | 66.2% | ❌ -6.6% vs empresa |
| **Relación con el Trabajo** | 64.5% | ❌ -6.8% vs empresa |

#### Desglose por Dimensión (vista detallada disponible en el sistema)
