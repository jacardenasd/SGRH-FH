...
$string['blindmarkingnogradewarning'] = 'Los envíos anónimos están habilitados para esta actividad. Las calificaciones no serán añadidas al libro de calificaciones hasta que se revele la identidad de los estudiantes mediante el menú de acciones de calificación.';
...
$string['defaultlayout'] = 'Restaurar el acomodo predeterminado';
...
$string['editingstatus'] = 'Estado de la edición';
...
$string['errorgradechangessaveddetail'] = 'Los cambios en la calificación y la retroalimentación no se pudieron guardar';
...
$string['eventsubmissionstatusupdated'] = 'El estado del envío ha sido actualizado';
$string['eventsubmissionstatusviewed'] = 'El estado del envío ha sido visto.';
...
<p>Usted puede ver el estado de su <a href="{$a->url}">envío de tarea</a>.</p>';
...
$string['submissiondrafts_help'] = '¿Los estudiantes deberían tener un botón de envío para indicar cuándo han terminado de realizar cambios en su envío y está listo para ser calificado?';
...
Puede ver el estado de su <a href="{$a->url}">trabajo enviado</a>.';
...
$string['viewownsubmissionstatus'] = 'Ver página de estados de las entregas propias.';
