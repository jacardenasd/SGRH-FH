...
$string['changetoplaywithmove'] = 'El modo de juego ha cambiado a "Jugando con ubicación por GPS".';
$string['changetoplaywithoutmoving'] = 'El modo de juego ha cambiado a "Jugando con pegmen"  <img src="pix/my_location.png" width="32" align="middle" /> (click on map)';
...
$string['customlayerservicearcgis'] = 'Servicio Tile Arcgis REST (experimental)';
$string['customlayerserviceimage'] = 'Imagen subida';
$string['customlayerservicetiled'] = 'Imagen XYZ en mosaico';
$string['customlayerservicetype'] = 'Tipo de la capa personalizada';
$string['customlayerservicetype_help'] = 'La capa personalizada puede ser un servicio WMS, un servidor de mosaicos {x}{y}{z}, un servidor de Mosaico ArcGIS REST (experimental) , o una imagen subida.';
$string['customlayerservicewms'] = 'Servicio WMS';
...
$string['customlayerwms'] = 'URL de servicio web de mapa (WMS, servidor de mosaico XYZ)';
$string['customlayerwms_help'] = 'Utilice una capa de mapa de un servicio WMS de OGC o de un servidor de mosaicos REST de ArcGIS. Por ejemplo: <ul><li>EUNIS Forest Ecosystems WMS se puede configurar mediante: WMS: <code style="overflow-wrap: break-word;word-wrap: break-word;">http://bio.discomap.eea.europa.eu/arcgis/services/Ecosystem/Ecosystems/MapServer/WMSServer</code> PARÁMETROS: <code>LAYERS=4</code>)</li><li>Servicio de mosaicos XYZ (solo para España) <code>https://tms-ign-base.idee.es/1.0.0/IGNBaseTodo/{z}/{x}/{-y}.jpeg</code></li><li>(Experimental) Los servicios de mosaicos rest de ArcGIS podrían ser <code>http://services.arcgisonline.com/ArcGIS/rest/services/World_Topo_Map/MapServer</code> o https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer';
...
$string['custommaplayertype'] = 'Tipo personalizado de capa';
$string['custommaplayertype_help'] = 'La capa personalizada puede ser la única visible en el fondo o puede estar puesta arriba de los mapas base estándar.';
...
$string['custommapnolayer'] = 'Sin mapa personalizado';
$string['custommapnongeographic'] = 'La imagen no es geográfica y será la única capa en el mapa.';
...
$string['custompreserveaspectratio'] = 'Conservar proporción de aspecto';
$string['custompreserveaspectratio_help'] = 'Si se habilita, la imagen será cambiada de escala (Este-Oeste) para que ajuste con la extensión de la latitud geográfica (Norte-Sur), conservando la proporción de aspecto. Es necesario para permitir que las imágenes SVG sean renderizadas sin pixelado.';
$string['customwmsparams'] = 'Parámetros extra de servicio web del mapa';
...
$string['geolocation_problem'] = 'La ubicación por GPS está teniendo problemas.';
...
$string['localizationbuttondisabled'] = 'Deshabilitar botón de localización';
$string['localizationbuttondisabled_help'] = 'Si se activa, el botón de localización se desactivará en la interfaz del reproductor.';
$string['lockactivitiessection'] = 'Restringir actividades a solo esta etapa.';
$string['lockactivity'] = 'Permitir solo en esta etapa';
$string['lockactivity_help'] = 'Bloquear el acceso a las actividades seleccionadas si el usuario no se encuentra en esta etapa. Esta configuración configura automáticamente las restricciones para las actividades seleccionadas. ADVERTENCIA: Esta configuración solo proporciona una configuración automática básica. Si usted edita manualmente las restricciones de una actividad, es posible que ya no aparezca aquí y que la configuración automática no funcione.';
$string['lockactivityannounce'] = 'Si el <a href="https://github.com/juacas/moodle-availability_treasurehunt">plugin de acceso condicional de Treasurehunt</a> está habilitado en este sitio, usted  puede hacer que cualquier actividad no esté disponible cuando el usuario no esté trabajando en esta etapa.';
...
$string['playerstyle_help'] = 'Puede haber varios estilos de la pantalla del juego que los profesores pueden elegir';
...
$string['prevstep'] = 'Ant.';
$string['privacy:metadata:treasurehunt_attempts'] = 'La Búsqueda del tesoro almacena el tipo, hora y ubicación de los intentos, éxitos y fracasos de los usuarios durante la actiidad';
$string['privacy:metadata:treasurehunt_attempts:groupid'] = 'El grupo en el cual el usuario jugó la actividad.';
$string['privacy:metadata:treasurehunt_attempts:location'] = 'La ubicación del usuario al momento del intento.';
$string['privacy:metadata:treasurehunt_attempts:stageid'] = 'La ID de la etapa que el usuario estaba intentando resolver.';
$string['privacy:metadata:treasurehunt_attempts:timecreated'] = 'La hora cuando el usuario hizo un intento.';
$string['privacy:metadata:treasurehunt_attempts:userid'] = 'La ID del usuario que hizo un intento,';
$string['privacy:metadata:treasurehunt_track'] = 'La Búsqueda del tesoro almacena la secuencia de ubicaciones seguidas por un usuario durante la actividad.';
$string['privacy:metadata:treasurehunt_track:location'] = 'La ubicación del usuario en un momento particular.';
$string['privacy:metadata:treasurehunt_track:timestamp'] = 'La hora cuando el usuario está siendo monitoreado.';
$string['privacy:metadata:treasurehunt_track:treasurehuntid'] = 'La ID de la Búsqueda del tesoro que el usuario está jugando.';
$string['privacy:metadata:treasurehunt_track:userid'] = 'La ID del usuario que está siendo monitoreado.';
...
$string['searchpaneldisabled'] = 'Deshabilitar el panel de búsqueda en el reproductor';
$string['searchpaneldisabled_help'] = 'Si se activa, el panel de búsqueda se deshabilitará en la interfaz del reproductor.';
$string['send'] = 'Enviar';
...
$string['showdistancehint'] = 'Mostrar pista de distancia';
$string['showdistancehint_help'] = 'Si se habilita, el jugador verá una pista de la distacia a la siguiente etapa. La pista será mostrada en la interfaz del jugador cuando el usuario esté cerca de la siguiente etapa.';
$string['showheadinghint'] = 'Mostrar pista dirección';
$string['showheadinghint_help'] = 'Si se habilita, el jugador verá una pista de la dirección hacia la siguiente etapa. La pista será mostrada en la interfaz del jugador cuando el usuario esté cerca de la siguiente etapa.';
$string['showinzonehint'] = 'Mosrar pista en zona';
$string['showinzonehint_help'] = 'Si se habilita, el jugador verá una pista cuando esté en la zona de la siguiente etapa. La pista será mostrada en la interfaz del jugador cuando el usuario esté rn la zona de la siguiente etapa.';
$string['shownextareahint'] = 'Mostrar pista siguiente área';
$string['shownextareahint_help'] = 'Si se habilita, el jugador verá el área de la siguiente etapa.';
...
$string['webserviceerror'] = 'Falló la comunicación con el servidor. Pudiera ser un problema temporal; por favor inténtelo de nuevo más tarde. Si el problema persiste, póngase en contacto con su administrador.';
