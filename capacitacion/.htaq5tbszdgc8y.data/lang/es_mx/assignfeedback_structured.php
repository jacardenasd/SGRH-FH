...
/**
 * Strings for component 'assignfeedback_structured', language 'es_mx', version '4.4'.
 *
...
$string['criteriasetdelete'] = 'Eliminar conjunto de criterios';
...
$string['defaultcritdesc'] = 'Descripción predeterminada para primer criterio';
$string['defaultcritdesc_help'] = 'Descripción predeterminada opcional para el primer criterio de retroalimentación en todas las tareas nuevas.';
$string['defaultcritname'] = 'Nombre predeterminado para primer criterio';
$string['defaultcritname_help'] = 'Nombre predeterminado opcional para el primer criterio de retroalimentación en todas las tareas nuevas.<br>Tenga en cuenta que al ingresar un valor aquí se habilitará automáticamente el método de retroalimentación estructurada para todas las tareas nuevas.';
