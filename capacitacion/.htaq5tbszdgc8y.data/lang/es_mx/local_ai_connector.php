...
/**
 * Strings for component 'local_ai_connector', language 'es_mx', version '4.4'.
 *
...
$string['error:file_not_found'] = 'Archivo no encontrado.';
$string['error:openai_client'] = 'Error del cliente de OpenAI';
$string['error:openai_files'] = 'Error del archivo de OpenAI';
