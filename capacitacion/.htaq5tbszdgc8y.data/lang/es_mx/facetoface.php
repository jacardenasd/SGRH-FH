...
$string['bookedvscapacity'] = 'Reservado / Capacidad';
...
$string['customfield_visibility_help'] = 'Esta configuración determina quén puede ver el campo personalizado y el valor al enlistar sesiones en la página del módulo o cuando se registra  para una sesión.';
...
$string['datebooked'] = 'Fecha reservado';
...
$string['error:cancellationtooclose'] = 'Usted no tiene permitido cancelar esta reservación. Las reservaciones solo pueden ser canceladas {$a} antes de la sesión.';
...
$string['error:fieldselected'] = 'Este campo es selecionado para ser mostrado en la página del curso. Por favor seleccione un campo diferente.';
...
$string['error:multipleusersessions'] = 'Ususario {$a} tiene más de una sesión';
...
$string['facetofaceattendee'] = 'Asistente Cara-a-Cara';
...
$string['facetofacesessiondates'] = 'Fechas de sesión Cara-a-Cara';
...
$string['icalendarclass:confidential'] = 'Confidencial';
$string['icalendarclass:private'] = 'Privado';
$string['icalendarclass:public'] = 'Público';
...
$string['or'] = 'o';
$string['order'] = 'Orden';
$string['partiallyfull'] = 'Parcialmente lleno';
$string['place'] = 'Sala';
...
$string['seatsbooked'] = 'Asientos reservados';
...
$string['sessionavailability'] = 'Disponiblidad de sesión';
...
$string['sessionfinished'] = 'Terminado';
$string['sessionfinishtime'] = 'Hora de término de sesión';
$string['sessionid'] = 'Número ID de sesión';
...
$string['sessionnotstarted'] = 'No iniciado';
...
$string['sessionstatus'] = 'Estado de la sesión';
$string['sessionvenue'] = 'Sitio de la sesión';
$string['sessionvisibility'] = 'Visibilidad de la sesión';
$string['sessionvisibility_help'] = '* Mostrar: La sesión aparece en la lista y los estudiantes pueden acceder a ella.
* Ocultar: El acceso está restringido a profesores y otros usuarios con la capacidad para editar sesiones.';
...
$string['setting:cancelrestriction'] = 'Tiempo mínimo antes de una sesión cuando el estudiante puede cancelar su reservación. Dentro de este período no están permitidas las cancelaciones.';
$string['setting:cancelrestriction_caption'] = 'Restricción de cancelación';
...
$string['setting:icalendarclass_caption'] = 'Nivel de privacidad de evento de iCalendar presdeterminado';
$string['setting:icalendarclass_desc'] = 'Seleccionar el nivel de privacidad preseterminado (CLASS) para eventos cuando se exportan a iCalendar.';
...
$string['setting:sessioncompletiondate'] = 'Cuando se habilita, la fecha de terminación de sesión será usada como la hora de finalización al calificar asistencia.';
$string['setting:sessioncompletiondate_caption'] = 'Usar fecha y hora de rerminación de sesión para finalización.';
...
$string['setting:showinsummary'] = 'Mostrar en exportaciones';
$string['setting:type'] = 'Tipo de campo';
$string['setting:visiblefield'] = 'Mostrar el campo como una columna adicional en la vista de lista de sesión.';
$string['setting:visiblefield_caption'] = 'Campo visible en página de curso';
