...
/**
 * Strings for component 'tool_policy', language 'es_mx', version '4.4'.
 *
 * @package     tool_policy
 * @category    string
...
$string['activate'] = 'Configurar estado a "Activo"';
...
$string['idontagree'] = 'Yo no estoy de acuerdo con la {$a}.';
$string['inactivate'] = 'Configurar estado a "inactivo"';
