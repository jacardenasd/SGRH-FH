...
$string['customfilename'] = 'Nombre del archivo PDF personalizado';
$string['customfilename_help'] = 'Este es el nombre del archivo PDF para cada certificado. Si se deja en blanco, se utilizará la misma estructura que siempre: <i>certificatename_issueid.pdf</i>.<br>
...
<li>{issueid}: Id. de emisión</li>
<li>{coursename}: Nombre del curso</li>
<li>{userid}: Id. de usuario</li>
<li>{useridnumber}: Número de Id. de usuario</li>
<li>{userfullname}: Nombre completo del usuario</li>
<li>{userfirstname}: Nombre del usuario</li>
<li>{userlastname}: Apellido(s) del usuario</li>
<li>{timecreated1}: Hora de emisión (A_m)</li>
<li>{timecreated2}: Hora de emisión (Amd)</li>
<li>{timecreated3}: hora de emisión (Amd_His)</li>
</ul>';
