...
/**
 * Strings for component 'studentquiz', language 'es_mx', version '4.4'.
 *
 * @package     studentquiz
 * @category    string
...
$string['completionpointgroup_help'] = 'Los estudiantes ganan puntos según se especifica debajo de Configuraciones de ranking; por ejemplo, 10 puntos por crear una pregunta, 5 puntos porque el profesor aprueba la pregunta dle estudiantes, 3 puntos porque el estudiante valora la pregunta de otro. Al ingresar un valor numérico en el campo, los estudiantes solamente competan el StudentQuiz una vez que hayan acumulado suficientes puntos.';
...
$string['completionquestionapprovedgroup_help'] = 'El número mínimo de preguntas únicas que un estudiante debe escribir y tener aprobadas antes de que la actividad esté completada. Esta opción puede ser usada, ya sea que al Publicar la pregunta se "Requiera aprobación antes de publicar", o con la configuración de Auto-aprobación", pero no será tan efectiva con esta última, en caso de que las preguntas auto-aprobadas sean después ocultadas, eliminadas o de alguna otra forma removidas.';
...
$string['completionquestionpublishedgroup_help'] = 'El número mínimo de preguntas únicas que un estudiante debe escribir antes de que la actividad esté completada. Tenga en cuenta que esta es una simple comprobación numérica - dos preguntas que sean ocultas/eliminadas todavía se cuentan como que han sido creadas.';
...
$string['filter_label_answered'] = 'Contestado';
...
$string['filter_label_notmine'] = 'No es mio';
$string['filter_label_notmine_help'] = 'Preguntas no creadas por usted';
...
$string['filter_label_owner'] = 'Propietario';
