...
/**
 * Strings for component 'simplelesson', language 'es_mx', version '4.4'.
 *
...
$string['allowreports'] = 'Permitirle a estudiantes revisar respuestas anteriores.';
$string['allowreports_help'] = 'Los estudiantes no pueden revisar intentos anteriores de forma predeterminada. Active esta casilla para permitir que aparezca el botón de \'Revisar\'';
$string['allowreview'] = 'Permitirle al estudiante revisar intentos inmediatamente después del intento actual';
...
$string['allversions'] = 'Mostrar versiones de todas las preguntas';
$string['allversions_help'] = 'Las preguntas con múltiples versiones y que tengan un estado de Listo pueden tener todas sus versiones mostradas cuando se añade una pregunta.';
...
$string['noreview'] = 'Usted no tiene permitido revisar sus respuestas anteriores.';
...
$string['review'] = 'Revisar sus respuestas';
$string['reviewall'] = 'Revisar';
