...
/**
 * Strings for component 'gradingform_multigraders', language 'es_mx', version '4.4'.
 *
...
$string['err_grader_intermediary'] = '<b>{$a}</b> - Usted no puede publicar la calificación paar este estudiante porque usted no es el calificador final..';
...
$string['err_notgraded'] = '<b>{$a}</b> - Este estudiante no está calificado';
...
$string['now_grading'] = 'Ahora calificando: {$a}';
$string['pluginname'] = 'Múltiples evaluadores';
$string['previewdefinition'] = 'Previsualizar definición';
$string['privacy:metadata'] = 'Este plugin no almacena ningún dato personal del usuario. Cualquier información del usuario mostrada está almacenada en otro lugar en Moodle.';
...
$string['show_notify_student_box'] = '¿Mostrar caja de notificar a estudiante?';
$string['show_notify_student_box_help'] = 'Si se activa, los calificadores pueden elegir si mostrar o no la caja de notificar al estudiante';
