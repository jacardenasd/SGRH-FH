...
/**
 * Strings for component 'filter_wiris', language 'es_mx', version '4.4'.
 *
...
$string['contact'] = 'Para más información, vea <a href="https://docs.wiris.com/mathtype/en/mathtype-for-lms/mathtype-for-moodle.html">nuestra documentación </a> o si Usted tiene una duda, póngase en contacto con el soporte de WIRIS:';
...
$string['existsandenabledinmoodle'] = '¿Existe {$a} y está habilitado en Moodle?';
$string['existsinmoodle'] = '¿Existe {$a} en Moodle?';
$string['failure'] = 'FALLA';
...
$string['mttinymcelegacy'] = 'MathType para TinyMCE (antiguo)';
...
$string['tinymceincompatibility'] = 'MathType para TinyMCE (antiguo) no está soportado en Moodle 4.2 ni superiores; usted debe des-instalar el plugin localizado en  "./lib/editor/tinymce/plugins/tiny_mce_wiris" y usted debe instalar el plugin MathType para TinyMCE 6. Usted puede <a href="https://moodle.org/plugins/tiny_wiris">instalarlo aquí</a>.';
$string['tinymcelegacy'] = 'TinyMCE (antiguo)';
$string['title'] = 'Página de prueba del filtro MathType';
$string['version'] = 'versión';
$string['versionmustbethesame'] = 'Las versiones de MathType para cualcuer editor HTML y el Visor MathType DEBN DE ser la misma para que el plugin funcione adecuadamente.';
