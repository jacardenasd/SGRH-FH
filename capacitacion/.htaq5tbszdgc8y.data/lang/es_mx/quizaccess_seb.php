...
/**
 * Strings for component 'quizaccess_seb', language 'es_mx', version '4.4'.
 *
...
$string['seb:manage_seb_allowcapturecamera'] = 'Cambiar la configuración del examen SEB: Permitir el acceso del navegador a la cámara';
$string['seb:manage_seb_allowcapturemicrophone'] = 'Cambiar la configuración del examen SEB: Permitir el acceso del navegador al micrófono';
...
$string['seb_allowcapturecamera'] = 'Permitir el acceso del navegador a la cámara';
$string['seb_allowcapturecamera_help'] = 'Si está habilitado, se solicitará a los usuarios que permitan el acceso a la cámara para SEB antes de que comience la sesión de examen. En macOS 12/iOS 15 o posterior, deshabilitar esta opción impide que las aplicaciones web accedan a la cámara en cualquier caso; es decir, no será posible grabar vídeo mediante WebRTC.';
$string['seb_allowcapturemicrophone'] = 'Permitir el acceso del navegador al micrófono';
$string['seb_allowcapturemicrophone_help'] = 'Si está habilitada, se solicitará a los usuarios que permitan el acceso al micrófono para SEB antes de que comience la sesión de examen. En macOS 12/iOS 15 o posterior, deshabilitar esta opción impide que las aplicaciones web accedan al micrófono en cualquier caso; es decir, no será posible grabar audio mediante WebRTC.';
