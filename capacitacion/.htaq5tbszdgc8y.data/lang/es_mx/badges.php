...
$string['donotaward'] = 'Actualmente, esta insignia no está activa, por lo que no puede ser otorgada a usuarios. Si Usted desea otorgar esta insignia, por favor configure su estado a activo.';
...
$string['error:cannotsendtobackpack'] = '<strong>No se puede agregar la insignia a la mochila</strong><br />
El proveedor de tu mochila le está enviando este mensaje: \'{$a}\'.<br /><br />
Puede intentar descargar la insignia y agregarla manualmente a su mochila, o volver a intentarlo más tarde.';
...
$string['wrongrole'] = 'El rol que quiere usar no está asignado a usted.';
$string['year'] = 'Año(s)';
