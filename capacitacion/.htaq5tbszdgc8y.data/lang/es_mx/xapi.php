...
/**
 * Strings for component 'xapi', language 'es_mx', version '4.4'.
 *
 * @package     xapi
 * @category    string
...
$string['privacy:metadata:registration'] = 'La UUID del registro de xAPI';
...
$string['xapicleanupperiod_help'] = 'Quitar cualquier xAPI almacenado que no esté actualizado en el período seleccionado.';
