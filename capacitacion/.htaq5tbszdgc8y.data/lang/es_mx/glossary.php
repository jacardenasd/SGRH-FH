...
/**
 * Strings for component 'glossary', language 'es_mx', version '4.4'.
 *
 * @package     glossary
 * @category    string
...
$string['cnffullmatch'] = 'Define si una entrada, cuando está vinculada, debe coincidir con palabras completas (y no palabras dentro de otras palabras) de forma predeterminada.';
