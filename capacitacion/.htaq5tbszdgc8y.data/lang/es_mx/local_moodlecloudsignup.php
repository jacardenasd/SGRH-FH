...
/**
 * Strings for component 'local_moodlecloudsignup', language 'es_mx', version '4.4'.
 *
...
$string['portal:billing.events.chargedunsuccessfully.html'] = '<h1>¡Vaya! Tu pago de MoodleCloud ha fallado</h1>
<p>Intentamos renovar tu suscripción a MoodleCloud con tus datos de pago actuales, pero tu pago ha sido rechazado.</p>
<p>Lo intentaremos de nuevo el %nextBillingDate%, por favor revisa tu <a href="https://moodlecloud.com/es/">Portal</a> para asegurarte de que tus datos de pago sean válidos y estén actualizados.</p>
<p>Si tu pago es rechazado nuevamente, tu suscripción será cancelada y los anuncios se mostrarán nuevamente a los estudiantes en tu sitio.</p>
<p>¡Gracias por usar MoodleCloud!</p>
<p>El equipo de MoodleCloud</p>';
$string['portal:billing.events.chargedunsuccessfully.plain'] = '¡Vaya! Su pago de MoodleCloud ha fallado

Intentamos renovar su suscripción a MoodleCloud con sus datos de pago actuales, pero su pago ha sido rechazado.

Lo intentaremos nuevamente el %nextBillingDate%, por favor revise su <a href="https://moodlecloud.com/es/">Portal</a> para asegurarse de que sus datos de pago sean válidos y estén actualizados.

Si su pago es rechazado nuevamente, su suscripción será cancelada y los anuncios se mostrarán nuevamente a los estudiantes en su sitio.
...
$string['portal:billing.events.wentpastdue.plain'] = '¡Vaya! Su pago de MoodleCloud ha sido rechazado nuevamente

Su pago recurrente para el complemento \'ocultar anuncios de la vista de los estudiantes\' en su sitio %url% ha fallado 3 veces. (Le sugerimos que verifique la validez de su tarjeta de crédito con el proveedor de la tarjeta).

Los anuncios se volverán a mostrar a los estudiantes en su sitio.

Puede optar por renovar su suscripción para ocultar los anuncios nuevamente en cualquier momento visitando su portal de MoodleCloud: https://moodlecloud.com/es/.
