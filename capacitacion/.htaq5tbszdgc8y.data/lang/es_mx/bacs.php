...
/**
 * Strings for component 'bacs', language 'es_mx', version '4.4'.
 *
 * @package     bacs
 * @category    string
...
$string['advancedsettingsmessage1'] = 'Esta sección proporciona acceso directo para realizar operaciones complicadas con los datos del concurso. Por ejemplo, copia rápida de concursos, depuración o configuración de tareas que no están presentes en la base de datos.';
...
$string['devirtualizewarning'] = '¿Estás seguro de que quieres eliminar la participación virtual? Los envíos de los usuarios NO se eliminarán. Los datos de participación virtual no se pueden restaurar.';
...
$string['submissionsspampenalty'] = '¡Has enviado demasiados envíos! Has enviado 50 envíos en los últimos 5 minutos. El envío de soluciones está temporalmente prohibido. Intenta recargar esta página más tarde.';
$string['submissionsspamwarning'] = '¡Estás enviando demasiados envíos! Si envías 50 envíos en 5 minutos, perderás temporalmente la capacidad de enviar soluciones.';
