...
/**
 * Strings for component 'user', language 'es_mx', version '4.4'.
 *
 * @package     user
 * @category    string
...
$string['target:upcomingactivitiesdueinfo'] = 'Aquí están enlistadas todas las intuiciones (predicciones) de las próximas actividades futuras. Estos estudiantes han recibido estas intuiciones (predicciones) directamente.';
