...
/**
 * Strings for component 'theme_schoollege', language 'es_mx', version '4.4'.
 *
...
$string['coursetilebg_desc'] = 'Esta es la imagen predeterminada para los mosaicos de cursos en el Panel de control y la imagen de encabezado predeterminada para todos los cursos en los que un profesor no ha cargado una imagen en la Configuración del curso. Incluso con las Imágenes de encabezado desactivadas, puede usar una imagen aquí para que sea la imagen predeterminada del mosaico de cursos del Panel de control.';
...
$string['footeroverlay_desc'] = 'Superposición recomendada: Brushed.png. Puedes elegir cambiar la textura del fondo del pie de página. Descargamos imágenes de fondo transparente desde aquí: <a href="https://www.transparenttextures.com/">https://www.transparenttextures.com/</a>';
...
$string['headeroverlay_desc'] = 'Superposición recomendada: Brushed.png. Puedes elegir cambiar la textura del fondo del encabezado. Descargamos imágenes de fondo transparente desde aquí: <a href="https://www.transparenttextures.com/">https://www.transparenttextures.com/</a>';
...
$string['naviconbuttonurldesc'] = 'URL a la que apuntará el botón. Puede vincular a cualquier sitio, incluidos sitios web externos, solo ingrese la URL correcta. Si su sitio Moodle está en un subdirectorio, la URL predeterminada no funcionará. Ajuste la URL para reflejar el subdirectorio. Por ejemplo, si "moodle" fuera su carpeta del subdirectorio, entonces la URL debería cambiarse a /moodle/my/';
...
$string['naviconslidedesc'] = 'Texto de icono sugerido: flecha-círculo-abajo. O elija de la lista que se encuentra <a href="https://fontawesome.com/v4.7.0/icons/" target="_new">aquí</a>. Solo ingrese lo que está después de "fa-", por ejemplo, "estrella".';
...
$string['presetfiles_desc'] = 'Los archivos de ajustes preestablecidos se pueden usar para modificar drásticamente la apariencia del tema. Consulta <a href=https://docs.moodle.org/dev/Boost_Presets>Ajustes preestablecidos de Boost</a> para obtener información sobre cómo crear y compartir tus propios archivos de ajustes preestablecidos. Schoollege requiere ciertas variables de ajustes preestablecidos de SCSS. Puede ver los ajustes preestablecidos del tema schoollege aquí: <a href=https://github.com/dbnschools/moodle-theme_schoollege/tree/master/scss/preset target=_blank>repositorio de ajustes preestablecidos de Github de schoollege</a>';
...
$string['rawscsspre_desc'] = '// Área de la barra de navegación superior</br>
$navbar-bg: #e3eaf5 ;</br>
$navbartextcolor: #333;</br>

// Área del encabezado superior</br>
$header-bg: #eef5f9;</br>

// Migas de pan en schoollege</br>
...
// Menú de iconos de la barra lateral</br>
...
// Área de pie de página inferior</br>
$footer-bg: #e5ebef;</br>
$footerlinkcolor: #333;</br>
$footertextcolor: #333;</br>

// Se utiliza para dar estilo al plugin Easy Enrollment</br>
...
$string['showheaderimages_desc'] = 'Permitir que schoollege use imágenes personalizadas para el área del encabezado. Aún puede configurar una imagen de mosaico de curso a continuación, pero no se usará como imagen de encabezado dentro de un curso. Esta configuración desactiva por completo el uso de imágenes de encabezado.';
