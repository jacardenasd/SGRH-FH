...
/**
 * Strings for component 'plagiarism_turnitinsim', language 'es_mx', version '4.4'.
 *
...
$string['getwebhookfailure:message'] = 'Es posible que haya un problema con el Webhook registrado en Turnitin para el plugin Plagiarism. La tarea programada que debía verificarlo no pudo conectarse con Turnitin. Revise los registros.';
...
$string['pluginname'] = 'Plugin Turnitin Integrity';
$string['pluginsetup'] = 'Configuración';
$string['privacy:metadata:plagiarism_turnitinsim_client'] = 'Para realizar correctamente una entrega a Turnitin, deben intercambiarse datos específicos del usuario entre Moodle y Turnitin. Para obtener más información sobre los plugins de Moodle y el RGPD, visite https://help.turnitin.com/feedback-studio/moodle/moodle-plugins-and-gdpr.htm.';
...
$string['taskadminupdate'] = 'Actualizar la configuración local del plugin Turnitin Integrity';
$string['taskgetreportscores'] = 'Recuperar las puntuaciones del informe para el plugin Turnitin Integrity';
...
$string['taskoutputpluginnotconfigured'] = 'No se pudo ejecutar la tarea a {$a} ya que el plugin Turnitin Integrity no está configurado. <br/>Vaya a la página de configuración del plugin en Administración de sitio para agregar sus credenciales de API de Turnitin.';
...
$string['tasksendqueuedsubmissions'] = 'Enviar archivos en cola del plugin Turnitin Integrity';
$string['turnitinapikey'] = 'Clave de la API de Turnitin';
$string['turnitinapiurl'] = 'URL de la API de Turnitin';
$string['turnitinconfig'] = 'Configuración del plugin';
...
$string['turnitinpluginsettings'] = 'Configuración del plugin Turnitin Integrity';
$string['turnitinsim'] = 'Plugin Turnitin Integrity';
