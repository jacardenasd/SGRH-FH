...
/**
 * Strings for component 'workshopallocation_scheduled', language 'es_mx', version '4.4'.
 *
...
$string['currentstatusreset_help'] = 'El guardar este formato con la casilla marcada resultará en que se reinicie el estado actual. Toda la información sobre la ejecución previa se quitará de forma tal que pueda ejecutarse de nuevo la asignación (si está habilitada arriba).';
