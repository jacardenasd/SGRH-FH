...
$string['cachedef_videocmids'] = 'ID de módulos del curso (por curso) que son videos (actividades URL que apuntan a YouTube o Vimeo)';
...
$string['contactdeveloper'] = 'Ponerse en contacto con el desarrollador';
...
$string['seczerocollapsible'] = 'Sección cero colapsable';
$string['seczerocollapsible_desc'] = 'Permitirle al usuario colapsar la sección cero en el curso';
