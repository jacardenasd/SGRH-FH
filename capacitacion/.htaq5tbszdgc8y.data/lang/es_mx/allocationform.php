...
/**
 * Strings for component 'allocationform', language 'es_mx', version '4.4'.
 *
...
$string['activitydate:closes'] = 'Fecha límite:';
...
$string['allocationform_allocations'] = 'Asignaciones';
$string['allocationform_allocations:allocation'] = 'Asignación';
$string['allocationform_choices'] = 'Opciones del usuario';
$string['allocationform_choices:notwant'] = 'No querer';
$string['allocationform_options'] = 'Opciones';
$string['allocationform_options:heading'] = 'encabezado de opción';
$string['allocationform_options:maxallocation'] = 'Asignaciones máximas';
$string['allocationform_options:name'] = 'Nombre de opción';
$string['allocationform_options:sortorder'] = 'Orden de acomodo';
...
$string['allocationforms'] = 'Formato de asignación';
$string['allocationforms:namelink'] = 'Nombre con enlace';
$string['allocationforms:options'] = 'Opciones';
$string['allocationforms:options_text'] = 'Número de opciones: {$a->numberofchoices}, Número de asignaciones: {$a->numberofallocations}, No querer habilitado: {$a->notwant}';
$string['allocationforms:processed'] = 'Fecha de procesamiento';
$string['allocationforms:state'] = 'Estado';
$string['allocationforms:user'] = 'ID del usuario';
...
$string['aria:delete'] = 'Eliminar {a}';
$string['aria:edit'] = 'Editar {a}';
$string['aria:restrict'] = 'Retringir {a}';
...
$string['completiondetail:choice'] = 'Enviar opciones';
...
$string['timeline:avaliable'] = 'Hay asignaciones disponibles';
$string['timeline:deadline'] = 'Fecha límite para la elección del formato de asignación';
