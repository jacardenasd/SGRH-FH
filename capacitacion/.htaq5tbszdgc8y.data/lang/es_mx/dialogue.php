...
/**
 * Strings for component 'dialogue', language 'es_mx', version '4.4'.
 *
 * @package     dialogue
 * @category    string
...
$string['cannotreopendraftconversation'] = '¡Usted reabre una conversación que aún no ha iniciado!';
...
$string['conversationreopen'] = 'Conversación reabierta';
$string['conversationreopenconfirm'] = '¿Está seguro de querer reabrir la conversación {$a} ?';
$string['conversationreopened'] = 'Conversación {$a} ha sido reabierta';
...
$string['dialogue:reopen'] = 'Reabrir ahorita';
$string['dialogue:reopenany'] = 'Reabrir cualquiera';
...
$string['messageapibasicmessage'] = '<p>{$a->userfrom}  publicó un nuevo mensaje a una conversación en la que Usted está participando en el curso: <i>{$a->course}</i>
con asunto: <i>{$a->subject}</i>
...
$string['nopermissiontoreopen'] = '¡Usted no tiene permiso para reabrir esta conversación!';
...
$string['reopenconversation'] = 'Reabrir conversación';
...
$string['search:activity'] = 'Diálogo - información de actividad';
$string['search:conversations'] = 'Diálogo - información de mensaje y conversación';
