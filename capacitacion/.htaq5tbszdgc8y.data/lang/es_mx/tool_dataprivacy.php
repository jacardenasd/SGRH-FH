...
/**
 * Strings for component 'tool_dataprivacy', language 'es_mx', version '4.4'.
 *
...
$string['user'] = 'Usuario';
$string['userlistexplanation'] = 'Este plugin tiene el proveedor base pero también debería de implementar el userlist provider (proveedor de lista de usuarios) para soporte completo de funcionalidad de privacidad.';
$string['userlistnoncompliant'] = 'Falta userlist provider (proveedor de lista de usuarios).';
