...
/**
 * Strings for component 'subcourse', language 'es_mx', version '4.4'.
 *
 * @package     subcourse
 * @category    string
...
$string['refcourse_help'] = 'El curso referenciado es del que se toma la calificación para la actividad. Los estudiantes deberían de estar inscritos dentro del curso referenciado.
...
$string['settings:displayhiddencourses'] = 'Mostrar cursos ocultos';
$string['settings:displayhiddencourses_desc'] = 'Permitir que los cursos ocultos sean seleccionados al editar un subcurso.';
