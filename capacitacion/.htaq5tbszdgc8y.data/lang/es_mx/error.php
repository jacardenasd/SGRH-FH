...
/**
 * Strings for component 'error', language 'es_mx', version '4.4'.
 *
 * @package     error
 * @category    string
...
$string['cannotmarktopic'] = 'No se pudo marcar esa sección para este curso';
...
$string['downgradedcore'] = 'Error: El código que está utilizando es más antiguo que la versión registrada en la base de datos.';
...
$string['invalidsesskey'] = 'Su sesión muy probablemente ha caducado. Por favor compruebe si está ingresado en el sitio o regrese a la pantalla anterior y vuelva a cargar la página.';
...
$string['pluginnotexist'] = 'plugin {$a} no existe';
...
$string['redissessionhandlerproblem'] = 'Falló la configuración de sesión redis. Por favor notifique al administrador del servidor.';
...
$string['unknownhelp'] = 'Sección {$a} de ayuda desconocida';
...
$string['usernotaddedusernameexists'] = 'Usuario NO añadido - el nombre de usuario ya existe bajo un Email diferente';
