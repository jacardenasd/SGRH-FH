...
/**
 * Strings for component 'local_kopere_dashboard', language 'es_mx', version '4.4'.
 *
...
$string['add_report_user_fields_alt'] = 'Seleccione los campos de usuario que desea mostrar en los informes de Kopere.<br>
...
$string['backup_mark_all'] = 'Marcar/Desmarcar';
...
$string['cachedef_courses_all_courses'] = 'Cachear la lista de todos los cursos';
...
$string['contextactivity'] = 'Actividad';
$string['contextbadgecompletion'] = 'Finalización de insignia';
$string['contextcohort'] = 'Cohorte';
$string['contextcompetency'] = 'Competencia';
$string['contextcourse'] = 'Curso';
$string['contextcoursegroup'] = 'Grupo del curso';
$string['contextdefault'] = '...';
$string['contextduration'] = 'Duración';
$string['contextfunction'] = 'Función';
$string['contextgrade'] = 'Calificación';
...
$string['crontask_db_report_login'] = 'Cron para almacenar los inicios de sesión de usuario en una tabla temporal';
...
$string['deleted_successfully'] = 'Eliminado exitosamente';
$string['enable_debugmode'] = 'Debe habilitar el modo desarrollador y mostrar los mensajes de depuración.';
...
$string['install_kopere_bi_desc'] = '<p>Instale <a href="https://moodle.org/plugins/local_kopere_bi" target="_blank">Kopere BI</a> y obtenga acceso a informes avanzados y detallados para un mejor análisis de datos.</p>';
$string['install_kopere_bi_title'] = 'Instalar Kopere BI';
$string['integracaoroot'] = 'Integraciones';
$string['invisible'] = 'Oculto';
$string['kopere_dashboard:ajax'] = 'Cargar AJAX para el panel de control de Kopere';
...
$string['kopere_dashboard_pagefonts'] = 'Fonts Extra de Google';
$string['kopere_dashboard_pagefonts_desc'] = 'Agrega aquí el enlace @import de Google para fuentes adicionales.<br>Puede importar varias fuentes.<br><a href="https://fonts.google.com/selection/embed" target="google">Código para insertar</a><br><img src="{$a}" style="max-width: 100%;width: 420px;">';
...
$string['notification_core_course_completion'] = 'Finalización del Curso';
$string['notification_core_course_content'] = 'Contenido del Curso';
$string['notification_core_course_module'] = 'Módulo del Curso';
$string['notification_core_course_section'] = 'Secciones del Curso';
$string['notification_core_user'] = 'Usuarios';
$string['notification_core_user_enrolment'] = 'Registro de Usuario';
$string['notification_core_user_password'] = 'Contraseñas';
$string['notification_course_module_created'] = 'Nuevo Módulo de Curso Creado';
...
$string['notification_local_kopere_pay'] = 'Pago de Kopere';
$string['notification_manager'] = 'Gestionar Mensajes';
$string['notification_message'] = 'Mensaje';
$string['notification_message_edit_template'] = 'Editar la plantilla de Email base';
$string['notification_message_html'] = '<p>Hola {[to.fullname]},</p><p>&nbsp;</p><p>Att,<br>{[from.fullname]}.</p>';
$string['notification_message_html_core_course'] = '<p>Hola {[to.fullname]},</p>
<p>El usuario {[to.fullname]} acaba de realizar la acción de  <strong>{[event.name]}</strong> en el curso {[course.fullname]}.</p>
<p>Saludos,<br>{[admin.fullname]}.</p>';
$string['notification_message_html_core_course_category'] = '<p>Hola {[to.fullname]},</p>
<p>El usuario {[to.fullname]} acaba de realizar la acción <strong>{[event.name]}</strong> en la categoría {[category.fullname]}.</p>
<p>Saludos cordiales,<br>{[admin.fullname]}.</p>';
$string['notification_message_html_core_user'] = '<p>Hola {[to.fullname]},</p>
<p>El usuario {[to.fullname]} acaba de realizar la acción <strong>{[event.name]}</strong>.</p>
<p>Saludos cordiales,<br>{[admin.fullname]}.</p>';
$string['notification_message_html_core_user_enrolment'] = '<p>Hola {[to.fullname]},</p>
<p>El usuario {[from.fullname]} ha realizado la acción <strong>{[event.name]}</strong> para el usuario {[usertarget.fullname]}.</p>
<p>Saludos cordiales,<br>{[admin.fullname]}.</p>';
$string['notification_message_html_mod'] = '<p>Hola {[to.fullname]},</p>
<p>El usuario {[to.fullname]} ha realizado la acción <strong>{[event.name]}</strong> en el módulo {[module.name]} del curso {[course.fullname]}.</p>
<p>Saludos cordiales,<br>{[admin.fullname]}.</p>';
$string['notification_message_template_error'] = 'La plantilla debe incluir la etiqueta "{[message]}" para permitir la inserción de contenido personalizado.';
...
$string['notification_tags'] = '¿Qué etiquetas (TAGS) se reemplazan en los mensajes?';
$string['notification_testsmtp'] = 'Probar si las configuraciones SMTP son correctas.';
$string['notification_testsmtp_error'] = 'Moodle no envía correos electrónicos cuando el remitente y el destinatario son la misma persona. <br> Y usted es el administrador principal de este Moodle. Por lo tanto, para realizar la prueba, debe iniciar sesión con otro administrador.';
$string['notification_testsmtp_message'] = '<p>Esta es una prueba de envío de correo electrónico.</p>';
$string['notification_testsmtp_subject'] = 'Probando el envío de Email';
...
$string['notificationsend_course'] = 'Curso al cual enviar el mensaje';
$string['notificationsend_criteria'] = 'Criterios';
$string['notificationsend_criteria_days'] = '¿Cuántos días han pasado desde el último acceso al curso?';
$string['notificationsend_criteria_days_desc'] = 'Define el número de días sin acceso al curso para que se active la notificación. Cero se aplica a TODOS los estudiantes.';
$string['notificationsend_criteria_enrol'] = '¿Cuántos días han transcurrido desde la inscripción en el curso?';
$string['notificationsend_criteria_enrol_desc'] = 'Define el número de días transcurridos desde la inscripción en el curso para que se active la notificación. Cero se aplica a TODOS los estudiantes.';
$string['notificationsend_send'] = 'Enviar mensajes';
$string['notificationsend_test_title'] = 'Usuarios que recibirán el correo electrónico';
$string['notificationsend_title'] = 'Enviar notificación';
$string['notificationsend_to'] = 'Enviar mensajes';
$string['notificationsend_viewstudentswithcriteria'] = 'Ver estudiantes con estos criterios';
...
$string['privacy:metadata:ip'] = 'Dirección IP del usuario durante el acceso';
$string['privacy:metadata:user_id'] = 'Identificador de usuario único en el sistema';
...
$string['reports_settings_form_colunas_extra'] = '¡Déjalo en blanco si no lo necesitas!';
...
$string['reports_settings_form_prerequisit'] = 'Pre-requisito antes de cargar el reporte';
...
$string['reports_settings_form_prerequisit_courses_group_mode'] = 'Poner el modo de grupo en texto';
$string['reports_settings_form_prerequisit_listCourses'] = 'Lista de cursos';
$string['reports_settings_form_prerequisit_userfullname'] = 'Ejecutar fullname ($user) en cada línea del informe';
...
$string['saved_successfully'] = 'Guardado exitosamente';
$string['select'] = 'Seleccionar';
$string['select_month'] = 'Seleccionar Mes';
$string['setting_saved'] = '¡configuraciones gruardadas!';
$string['settings'] = 'Configuraciones';
$string['tags_message'] = '<h2>Título</h2><p>Línea 1</p><p>Línea 2</p>';
...
<p>Se ha creado una cuenta para ti en el sitio {[moodle.fullname]}.</p>
<p>Ahora, te invito a iniciar sesión en el área de estudiantes con los siguientes datos:</p>
<p><strong>Sitio:</strong> {[moodle.link]}<br>
   <strong>Usuario:</strong> {[to.username]}<br>
   <strong>Contraseña:</strong> {[to.password]}</p>
   <p>Si tienes alguna duda, puedes solicitar ayuda.</p>
<p>Atentamente,<br>
Equipo de Soporte</p>';
$string['userimport_event_import_user_created_subject'] = '¡BienVenido! - {[moodle.fullname]}';
$string['userimport_exist'] = 'El usuario ya existe. Ignorado';
...
$string['userimport_firstname_desc'] = 'Si dispone del nombre completo en un archivo CSV, simplemente rellene este campo; Kopere se encargará de generar ambos campos. Si su archivo CSV contiene un nombre y un apellido, seleccione ambos.';
$string['userimport_group_desc'] = 'Si desea que el estudiante esté vinculado a un grupo en el curso, la columna debe ser idéntica al nombre del grupo o al ID interno.';
...
$string['userimport_messageinactive'] = 'El mensaje titulado {$a} está inactivo y no se enviará.';
...
$string['userimport_notreceivemessage'] = '¡El usuario no recibirá ningún mensaje en esta acción!';
$string['userimport_passcreate'] = '--Será creado--';
$string['userimport_receivemessage'] = 'El usuario recibirá el mensaje con el título {$a}';
$string['userimport_referencedata'] = 'Referenciar datos de Moodle con CSV';
$string['userimport_separator_error'] = 'Debes exportar el CSV con separador ";" o ",".';
...
$string['vvveb_footer_contact_title_default'] = 'Póngase en contacto con nosotros';
...
$string['webpages_page_analytics'] = 'ID de seguimiento de Google Analytics';
$string['webpages_page_analyticsdesc'] = 'Secuencia de 13 caracteres, que comienza en UA';
...
$string['webpages_subtitle_help'] = 'Estos menús aparecen en Navegación, dentro de "Mis cursos".';
