...
/**
 * Strings for component 'local_sandbox', language 'es_mx', version '4.4'.
 *
...
$string['keepcoursename'] = 'Conservar el nombre del curso';
$string['keepcoursename_desc'] = 'de forma predeterminada, el curso restaurado tendrá el mismo nombre que tenía antes de la restauración. Esto significa que el nombre del curso no se restablece junto con el contenido. Esto puede ser especialmente útil si planea restaurar varios cursos con nombres distintos a partir de archivos de copia de seguridad idénticos. Sin embargo, en cuanto desactive esta opción, Sandbox cambiará a la configuración predeterminada: al restaurar el contenido del curso, descartará el nombre del curso existente y utilizará el nombre del archivo de copia de seguridad.';
...
$string['precheckerror'] = 'Error(es) en pre-comprobación';
