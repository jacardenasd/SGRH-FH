...
/**
 * Strings for component 'enrol_self', language 'es_mx', version '4.4'.
 *
 * @package     enrol_self
 * @category    string
...
Su inscripción en el curso {$a->course} expira en {$a->timeend} porque usted no lo ha visitado en los últimos {$a->inactivetime} días.

Para conservar activa su inscripción, simplemente ingrese al sitio y visite  <a href="{$a->url}">{$a->course}</a> antes de {$a->timeend}.';
$string['expiryinactivemessageenrolledsubject'] = 'Su inscripción está expirando: {$a->course}';
...
$string['passwordmatchesgroupkey'] = 'Esta clave de inscripción ya ha sido usada como una clave de inscripción a grupo.';
