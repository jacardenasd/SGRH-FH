...
/**
 * Strings for component 'role', language 'es_mx', version '4.4'.
 *
 * @package     role
 * @category    string
...
$string['course:overridecompletion'] = 'Anular estado de finalización de actividad';
...
$string['reportbuilder:viewall'] = 'Ver todos los reportes personalizados';
...
$string['siteadministratorsconfigphp'] = 'La lista de administradores del sitio NO puede ser cambiada porque está definida en config.php.';
...
$string['user:managesyspages'] = 'Configurar el acomodo de página predeterminado para los perfiles de usuario públicos';
