...
/**
 * Strings for component 'tool_lp', language 'es_mx', version '4.4'.
 *
 * @package     tool_lp
 * @category    string
...
$string['completeplanconfirm'] = '¿Configurar el plan de aprendizaje \'{$a}\' a completado? Si así fuera, el estado actual de todas las competencias de los usuarios será grabado, y el plan se volverá de solo lectura.';
...
$string['reopenplanconfirm'] = '¿Reabrir el plan de aprendizaje \'{$a}\'? Si así fuera, el estado de las competencias de los usuarios que estaban grabadas al momento de que el plan fuera previamente completado será eliminado, y el plan se volverá activo nuevamente.';
$string['requestreview'] = 'Solicitar revisión';
$string['reviewer'] = 'Revisor';
$string['reviewstatus'] = 'Revisar estatus';
$string['savechanges'] = 'Guardar cambios';
$string['scale'] = 'Escala';
$string['scale_help'] = 'Una escala determina como se mide la capacidad/pericia/dominio/maestría en una competencia. Después de seleccionar una escala, Usted debe de configurarla.
