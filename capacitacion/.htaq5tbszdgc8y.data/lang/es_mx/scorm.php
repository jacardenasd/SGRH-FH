...
/**
 * Strings for component 'scorm', language 'es_mx', version '4.4'.
 *
 * @package     scorm
 * @category    string
...
$string['completionstatusallscos_help'] = 'Algunos paquetes SCORM contienen componentes múltiples o "scos" - cuando esto está habilitado, todos los scos dentro del paquete deben de regresar el  lesson_status (estado-de-la-lección) relevante para que esta actividad sea marcada como completa.';
$string['completionstatusrequired'] = 'Requerir estatus';
$string['completionstatusrequired_help'] = 'All seleccionar uno o más estados se le exigirá al usuario que logre al menos un estado seleccionado para que pueda marcarse como finalizada esta actividad SCORM, al igual que cualquier otro requisito de Finalización de Actividad.';
...
$string['coursestruct'] = 'Estructura del contenido';
...
$string['displaycoursestructure'] = 'Mostrar estructura del contenido en la página de entrada';
$string['displaycoursestructure_help'] = 'Si está activado, la tabla de contenidos se mostrará en la página del esquema de SCORM.';
$string['displaycoursestructuredesc'] = 'Si se habilita, se muestra la tabla de contenidos en la página del esquema del SCORM';
...
$string['eventstatussubmitted'] = 'Estado de SCORM enviado';
...
$string['forcecompleted_help'] = 'Si se activa, el estado del intento actual se cambia a "Finalizado". Este ajuste sólo se aplica a los paquetes SCORM 1.2.';
...
* Cuando el intento anterior se completó, pasado o reprobado - Esto depende de que el paquete SCORM configure el estado de \'completado\', \'pasado\' o \'reprobado\'.
...
$string['hidetoc'] = 'Mostrar la estructura del contenido en el reproductor';
...
$string['masteryoverride_help'] = 'Si se habilita, y se proporciona un puntaje por maestría, cuando se llame a LMSFinish y se haya configurado un puntaje bruto, se re-calculará  el estado usando el puntaje bruto y el puntaje por maestría; y se anulará cualquier estado proporcionados por el SCORM (incluyendo "incompleto") .';
...
$string['minimumscoregreater'] = 'El puntaje mínimo debe ser mayor de 0.';
...
$string['privacy:metadata:aicc_session:lessonstatus'] = 'El estado de la lección a ser monitoreada';
$string['privacy:metadata:aicc_session:scormmode'] = 'El modo del elemento a ser monitoreado';
$string['privacy:metadata:aicc_session:scormstatus'] = 'El estado del elemento a ser monitoreado';
...
$string['whatgrade_help'] = 'Si se permiten múltiples intentos, esta configuración especifica si se almacenará en el libro de calificaciones el valor más alto, el promedio (la media), el primer intento o el último. La opción del último intento completado no incluye los intentos con estado de \'fallido\' o \'reprobado\'
...
$string['youmustselectastatus'] = 'Usted debe de seleccionar un estado a requerir';
