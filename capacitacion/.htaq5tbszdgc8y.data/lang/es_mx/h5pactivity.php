...
/**
 * Strings for component 'h5pactivity', language 'es_mx', version '4.4'.
 *
 * @package     h5pactivity
 * @category    string
...
$string['attempts_report_header_label'] = 'Intentos ({$a})';
...
$string['previewmode'] = 'Usted está en modo de previsualización.';
...
$string['trackingdisabled'] = 'Intentar monitorear no está habilitado para esta actividad.';
$string['trackingdisabled_enable'] = 'Intentar monitorear no está habilitado para esta actividad. Puede habilitarlo en <a href="{$a}">Configuraciones</a>.';
