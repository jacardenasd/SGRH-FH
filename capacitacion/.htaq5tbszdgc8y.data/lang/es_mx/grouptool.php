...
/**
 * Strings for component 'grouptool', language 'es_mx', version '4.4'.
 *
 * @package     grouptool
 * @category    string
...
$string['allow_multiple_help'] = 'Permitirle a los estudiantes que se registren en más de 1 grupo al mismo tiempo. Usted tiene que especificar cuantos grupos tienen al menos para escoger  (= grupos mínimos para escoger) y cuantos grupos tienen permitidos como máximo para escoger (= Máximo de grupos a elegir).';
...
$string['alwaysshowdescription_help'] = 'Si se deshabilita, la descripción de la tarea de arriba solamente se volverá visible para los estudiantes en la fecha de "Inicio del registro"..';
...
$string['define_amount_groups_help'] = 'Definir número de grupos N - Usted elige usuarios desde cual rol usar para creación del grupo y usted introduce la cantidad deseada de grupos en el campo de texto del número de Grupos/Miembros. En esquema del nombre usted puede ingresar un esquema de nombre para los grupos usando
<ul>
<li># (será reemplazado con el número-de-grupo) y</li>
<li>@ (será reemplazado con una letra que representa al número del grupo)</li>
</ul>
Entonces los usuarios elegidos son distribuidos en la cantidad deseada de grupos';
...
$string['namingscheme_help'] = '<p>El esquema del nombre define cómo serán nombrados automáticamente los grupos cuando usted añada nuevos grupos.</p>
<p>Por favor tenga en cuenta que:<br />
<ol><li>El  nombre de un grupo debe ser único dentro de su curso Moodle. </li>
<li>Si usted quiere crear más de un grupo a la vez, usted tiene que usar marcas (tags) para crear nombres únicos. </li></ol></p>
<p>Cada una de estas marcas (tags) será reemplazada en los nombres finales de grupo. Las marcas (tags) dentro de [] están relacionadas con los datos d los usuarios y los símbolos # y @ serán reemplazados por los números de serie de los grupos. Si JavaScript está habilitado, usted puede simplemente hacer clic en las marcas (tags) para añadirlas al esquema de nombres. Por favor considere que los nombres de los grupos tienen que ser únicos en cada curso y por lo tanto usted podría tenr que alterar el esquema de nombres hasta que esté libre de conflictos.</p>';
...
$string['queuesgrp_help'] = 'Si las colas de espera están habilitadas, los estudiantes que traten de registrarse en un grupo lleno son puestos en cola de espera hasta que alguien se des-registre del mismo grupo. Después de la fecha límite el profesor tiene  la habilidad de mover estudiantes a otros grupos si siguen en cola de espera, donde los grupos son llenados usando el orden de la lista de grupos actual. Usted debería definir un número máximo de grupos en los cuales un usuario puede ser puesto en lista de espera.<br />Limita el máximo de entradas en cola de espera para cada persona en este grouptool.';
...
$string['report'] = 'Reporte de Grouptool';
$string['require_registration'] = 'Requerir registros';
$string['require_registration_help'] = 'La cantidad mínima de grupos a los cuales deben registrarse los estudiantes para poder marcar esta actividad como completada. Los lugares e cola no son considerados por la regla. Si el número es mayor de 1 "Registros múltiples necesita estar activado y "Máximo de grupos a elegir" necesita ser mayor o igual a este valor.';
...
$string['show_members_help'] = 'Habilita que los estudiantes (bajo ciertas circunsatancias) puedan ver quien ya está registrado en un grupo.<br />
<ul>
    <li><strong>No:</strong> no mostrar para nada a los miembros del grupo</li>
    <li><strong>Todos - después de la fecha \'esperado para\':</strong> muestra miembros del grupo para todos los grupos después de la fecha esperada</li>
    <li><strong>Propio - después de la fecha \'esperado para\':</strong> muestra los miembros de su propio grupo después de la fecha esperada</li>
    <li><strong>Propio - después del registro:</strong> muestra los miembros de su propio grupo después de haberse registrado él/ella o de haber sido registrado por alguien más</li>
    <li><strong>Si:</strong> mostrar miembros del grupo</li>';
...
$string['toomanyregspresent'] = 'Al menos 1 usuario está registrado en demasiados grupos,; por lo tanto, el Máximo de grupos a elegir deberá ser como mínimo de {$a}.';
$string['total'] = 'Total';
...
$string['unregister_user_not_in_group'] = '¡El usuario <strong>{$a->fullname}</strong> (<strong>{$a->idnumber}</strong>) no está en el grupo Moodle <strong>{$a->groupname}</strong>!';
