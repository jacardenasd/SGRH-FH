...
/**
 * Strings for component 'choicegroup', language 'es_mx', version '4.4'.
 *
 * @package     choicegroup
 * @category    string
...
$string['choicegroupoptions_description'] = 'Definir opciones de grupo disponible para participantes';
...
$string['defaultgroupdescriptionstate'] = 'Visualización predeterminada de descripción de grupo';
$string['defaultgroupdescriptionstate_desc'] = 'Si es que la descripción del grupo es mostrada o no de forma predeterminada.';
