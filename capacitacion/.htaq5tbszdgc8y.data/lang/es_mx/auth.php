...
/**
 * Strings for component 'auth', language 'es_mx', version '4.4'.
 *
 * @package     auth
 * @category    string
...
$string['auth_changingemailaddress'] = 'Ha solicitado un cambio de dirección de correo electrónico, de {$a->oldemail} a {$a->newemail}. Por razones de seguridad, te enviamos un mensaje a su nueva dirección para confirmar que le pertenece. Su dirección de correo electrónico se actualizará en cuanto abra la URL que le enviamos en el mensaje. El enlace de confirmación caducará en 10 minutos.';
...
$string['auth_loginpasswordtoggle'] = 'Alternador de visibilidad de contraseña';
$string['auth_loginpasswordtoggle_desc'] = 'Añadir un ícono al campo de contraseña en la pantalla para ingresar, que le permita a los usuarios mostrar u ocultar su contraseña ingresada,';
...
$string['auth_sync_suspended'] = 'Si se habilita, el atributo suspendido será usado para actualizar el estado de suspensión de la cuenta del usuario local.';
$string['auth_sync_suspended_key'] = 'Sincronizar estado de suspensión del usuario local';
...
Ha solicitado un cambio en su dirección de correo electrónico de su cuenta en {$a->site}. Para confirmar este cambio, visite la siguiente dirección web:

{$a->url}
El enlace de confirmación caducará en <b>10 minutos</b>.
