...
/**
 * Strings for component 'block_my_external_backup_restore_courses', language 'es_mx', version '4.4'.
 *
...
$string['categorytable_categoryfield'] = 'Campo de tabla de base de datos único que representa la misma categoría para el Moodle actual y el Moodle extranjero implícito';
$string['categorytable_categoryfield_desc'] = 'Campo de tabla de base de datos único que representa la misma categoría para el Moodle actual y el Moodle extranjero implícito';
$string['categorytable_desc'] = 'Nombre de tabla de base de datos en donde está almacenada  la información de la categoría';
$string['categorytable_foreignkey'] = 'Clave externa de la tabla de base de datos para el ID de categoría';
$string['categorytable_foreignkey_desc'] = 'Clave externa de la tabla de base de datos para el ID de categoría';
$string['choose_to_restore'] = 'Seleccionar para restauración';
$string['defaultcategory'] = 'Id. de categoría donde se restauran los cursos de forma predeterminada';
...
$string['error_msg_admin'] = 'Error para el curso con id externo {$externalcourseid} e id interno {$courseid}, de {$externalmoodleurl}, para el nombre de usuario {$username}:\\n{$message}';
...
$string['external_moodleDesc'] = 'una lista formateada de Moodle externos como moodle_url1,token_compte_webservice_moodle_externe1;moodle_url2,token_compte_webservice_moodle_externe2;...';
$string['externalmoodlecourselist'] = 'Lista de cursos de Moodles externos';
$string['externalmoodlehelpsection'] = 'En la siguiente tabla: <ul><li>Seleccione los cursos remotos que desea restaurar en la plataforma actual</li><li>A continuación, haga clic en el botón "Enviar"</ul>
Se programará la restauración de los cursos.<br><br>
Puede consultar el estado de sus cursos programados para restauración (fecha programada, restauración completada, etc.).<br>
Se le enviará una notificación una vez que su curso se haya restaurado.';
...
$string['my_external_backup_restore_courses:addinstance'] = 'Agregar instancia de recuperación de copia de seguridad y restauración de cursos desde Moodle externo';
...
$string['my_external_backup_restore_courses:myaddinstance'] = 'Agregar instancia de recuperación de cursos de respaldo desde Moodle externo al Tablero';
$string['my_external_backup_restore_courses:view'] = 'Ver el bloque \'Restaurar cursos desde Moodles remotos\'';
...
$string['notexistinginternalcategory'] = 'El usuario "{$a->username}" no puede restaurar el curso en la categoría "{$a->internalcategoryname}" porque la categoría interna dada ya no existe. El curso se restaurará en la categoría "{$a->defaultcategoryname}".';
...
$string['roles_included_in_external_courses_search_Desc'] = 'Roles en el curso para agregar a la búsqueda externa del curso mientras se busca en los campos de usuario: nombres cortos delimitados por comillas simples `\' y separados por ,';
$string['status_-1'] = 'Error';
$string['status_0'] = 'Agendado';
$string['status_1'] = 'En progreso';
$string['status_2'] = 'Realizado';
$string['success_mail_main_message'] = 'La restauración del curso "{$a->externalcoursename}" de la plataforma Moodle {$a->externalmoodle} a la plataforma Moodle {$a->localmoodle} se completó exitosamente.';
$string['success_mail_subject'] = '[Restaurar curso Moodle] : un curso externo restaurado exitosamente';
$string['timelimitedmod'] = 'Ejecución entre dos mod de tiempo';
$string['timelimitedmod_desc'] = 'La ejecución entre dos mods de tiempo significa que la tarea asociada que importa y restaura cursos desde un Moodle externo no funcionará después de definir los límites de tiempo antes y después.';
