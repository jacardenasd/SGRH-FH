...
/**
 * Strings for component 'report_benchmark', language 'es_mx', version '4.4'.
 *
...
$string['slowwebsolution'] = '<ul><li><a href="{$a}" target="_blank">Purgar la caché de Moodle</a>.</li></ul>';
