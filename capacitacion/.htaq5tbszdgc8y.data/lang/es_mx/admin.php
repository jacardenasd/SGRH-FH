...
$string['configproxybypass'] = 'Lista de nombres de host o direcciones IP (parciales) que deben omitir el proxy. Separe los elementos con una coma y sin espacios, por ejemplo 192.168.0.0/16,*.midominio.com.';
...
$string['emoticons_desc'] = 'Este formato define los \'emoticons\' (o iconos gestuales o \'caritas\') usados en su sitio. Para eliminar una fila de la tabla, guarde el formato con un valor vacío en cualquiera de los campos obligatorios. Para registrar un nuevo \'emoticon\', rellene los campos de la última fila en blanco. Para restablecer todos los campos en los valores predeterminados, siga el enlace de arriba.

* Texto (obligatorio) - Este texto será reemplazado por la imagen de icono gestual. Debe ser de al menos dos caracteres de longitud.
* Nombre de la imagen (obligatorio) - El nombre del archivo de imagen del icono gestual sin la extensión, relativo a la carpeta de componentes pix.
* Componente de imagen (obligatorio) - El componente que proporciona el ícono.
* Texto alternativo (opcional) - identificador de cadena y los componentes del texto alternativo del icono gestual.';
...
$string['ensureauroraversion'] = 'Su sitio web utiliza el motor de base de datos de Amazon Aurora. Asegúrese de que la versión de MySQL en Amazon Aurora sea compatible con la versión de Moodle que está instalando o actualizando. Puede comprobar la compatibilidad en las <a href="https://docs.aws.amazon.com/AmazonRDS/latest/AuroraMySQLReleaseNotes/AuroraMySQL.Updates.30Updates.html" target="_blank">Actualizaciones del motor de base de datos para Amazon Aurora MySQL versión 3</a>.';
...
$string['geopluginapikey'] = 'Clave API GeoPlugin';
$string['geopluginapikey_desc'] = 'La clave API usada para acceder al servicio de GeoPlugin. Obtenga su propia clave en <a href="https://www.geoplugin.com/" target="_blank">GeoPlugin page</a>.';
...
$string['langmenuinsecurelayout'] = 'Mostrar menú de idiomas en acomodo seguro';
$string['langmenuinsecurelayout_desc'] = 'Si se habilita, un usuario podrá cambiar su idioma cuando intente un examen u otra actividad que usa acomodo seguro.';
...
$string['logininfoinsecurelayout'] = 'Mostrar usuario ingresado en acomodo seguro';
$string['logininfoinsecurelayout_desc'] = 'Si se habilita, el nombre completo del usuario ingresado será mostrado en la barra de navegación cuando intente un examen u otra actividad que usa acomodo seguro.';
...
$string['purgecachesconfirm'] = 'Moodle puede almacenar en caché temas, JavaScript, cadenas de idioma, texto filtrado, feeds RSS y otros datos calculados. Purgar las cachés eliminará datos del servidor y obligará a los navegadores a volver a obtenerlos, para que pueda estar seguro de ver los valores más actualizados generados por el código actual. Purgar las cachés no supone ningún riesgo, pero su sitio web podría verse más lento durante un tiempo hasta que el servidor y los clientes calculen la nueva información y la almacenen en caché.';
...
$string['settingzendexceptionignoreargs'] = 'Es altamente recomendable que la configuración PHP zend.exception_ignore_args esté habilitada como una precaución de seguridad..';
...
$string['soaprecommended'] = 'La instalación de la extensión opcional SOAP es útil para los servicios web y para algunos plugins.';
...
$string['unicoderequired'] = 'Todos los datos deben almacenarse en formato Unicode (UTF-8). En las nuevas instalaciones, la base de datos debe tener UTF-8 como conjunto de caracteres predeterminado. Si está realizando una actualización, debe seguir el proceso de migración a UTF-8.';
...
$string['unsupportedphpversion84'] = 'La versión PHP 8.4 y superiores no están soportadas.';
