...
/**
 * Strings for component 'auth_ldap', language 'es_mx', version '4.4'.
 *
 * @package     auth_ldap
 * @category    string
...
$string['auth_ldap_attrcreators'] = 'Lista de grupos o contextos cuyos miembros están habilitados para crear atributos. Separe los grupos con \',\'. Por ejemplo: \'cn=empleados,ou=personal,o=miorg';
...
$string['auth_ldap_groupecreators'] = 'Lista de grupos o contextos cuyos miembros están habilitados para crear grupos. Separe los grupos con \',\'. Por ejemplo: \'cn=profesores,ou=empleados,o=miorg';
...
$string['sync_updateuserchunk'] = 'Configure este valor al número de usuarios que usted quiere que sean subidos por cada transacción. El configurar esto a 0 actualizará a todos los usuarios en una transacción.';
$string['sync_updateuserchunk_key'] = 'Tamaño del grupo de Sincronizar actualizar usuarios';
