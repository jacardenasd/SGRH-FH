...
/**
 * Strings for component 'tool_generator', language 'es_mx', version '4.4'.
 *
...
$string['progress_createusers'] = 'Creando cuentas de usuario ({$a})';
...
$string['testscenario_description'] = 'Crear escenarios de prueba usa una sintaxis de archivos de característica limitada para crear todos los elementos para ejecutar una prueba manual.';
$string['testscenario_errorparsing'] = 'Error al procesar archivo de característica: {$a}';
$string['testscenario_file'] = 'Archivo de característica';
$string['testscenario_filedesc'] = 'Los archivos de subir característica solamente pueden contener escenarios con pasos core_data_generator. Aun no es compatible con esquemas de escenario. Todos los escenarios serán ejecutados enseguida pero los pasos del fondo serán ignorados.';
$string['testscenario_invalidfile'] = 'El formato del archivo no es válido o contiene pasos inválidos.';
$string['testscenario_invalidstep'] = 'Paso desconocido. Crear escenarios de prueba solamente acepta pasos del generador.';
$string['testscenario_nosteps'] = 'No hay pasos a ejecutar en el archivo.';
$string['testscenario_notready'] = 'Las librerías de Composer y Behat no están instaladas.<br><br>Ejecute este comando para habilitar esta herramienta: <strong>php admin/tool/generator/cli/runtestscenario.php</strong>';
$string['testscenario_outline'] = 'Los esquemas de escenario no están soportados.';
$string['testscenario_scenarionosteps'] = 'Este escenario no tiene ningún paso.';
$string['testscenario_steps'] = 'Probando pasos del escenario:';
