...
/**
 * Strings for component 'block_completion_progress', language 'es_mx', version '4.4'.
 *
...
$string['computeprogress'] = 'Calculando porcentajes de progreso';
...
$string['overviewcachetime'] = 'Tiempo para almacenar en caché los porcentajes calculados';
$string['pluginname'] = 'Progreso de Finalización';
$string['privacy:metadata:block_completion_progress:blockinstanceid'] = 'Identificador de instancia del bloque Progreso de finalización al que se relaciona el porcentaje.';
$string['privacy:metadata:block_completion_progress:percentage'] = 'El porcentaje de finalización.';
$string['privacy:metadata:block_completion_progress:tableexplanation'] = 'El bloque del Progreso de finalización almacena en caché los porcentajes de finalización para ordenar la tabla Descripción general.';
$string['privacy:metadata:block_completion_progress:timemodified'] = 'El momento en el que se calculó el porcentaje.';
$string['privacy:metadata:block_completion_progress:userid'] = 'El identificador de usuario al que se refiere el porcentaje.';
