...
/**
 * Strings for component 'report_outline', language 'es_mx', version '4.4'.
 *
...
$string['eventoutlinereportviewed'] = 'Reporte del esquema visto';
$string['neverseen'] = 'Nunca visto';
$string['nocapability'] = 'No puede accederse al reporte del esquema del usuario';
...
$string['page-report-outline-index'] = 'Reporte del esquema del curso';
$string['page-report-outline-user'] = 'Reporte del esquema del curso del usuario';
$string['page-report-outline-x'] = 'Cualquier reporte de esquema';
