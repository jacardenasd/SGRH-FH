...
/**
 * Strings for component 'enrol_gwpayments', language 'es_mx', version '4.4'.
 *
...
$string['cost'] = 'Precio de inscripción';
...
$string['enablebypassinggateway'] = '¿Se permite la omisión de portales de pago?';
$string['enablebypassinggateway_help'] = 'Cuando se activa, esto evitará completamente los portales de pago siempre que el precio (descontado) sea cero. Muchas PSP no pueden hacer frente a un pago con valor cero.
Debido a que no todas las implementaciones de portales de pago serán capaces de eludir el intento de realizar un pago con valor cero, sino que devolverán un error, este ajuste puede habilitarse para proporcionar una solución.';
...
$string['enrol:already'] = 'Ya se ha inscrito en el curso: {$a->fullname}';
$string['enrol:fail'] = 'No se ha inscrito en este curso.';
$string['enrol:invalid'] = 'Registro de inscripción no válido.';
$string['enrol:ok'] = 'Muchas gracias por su compra.<br> Ha sido inscrito en el curso: {$a->fullname}';
$string['enrolenddate'] = 'Fecha límite';
$string['enrolenddate_help'] = 'Si está activada, los usuarios solo pueden inscribirse hasta esta fecha.';
$string['enrolenddaterror'] = 'La fecha límite de la inscripción no puede ser anterior a la fecha de inicio';
$string['enrolfreepass'] = 'Usted ha sido inscrito de forma gratuita en el curso.';
$string['enrolperiod'] = 'Duración de la inscripción';
$string['enrolperiod_help'] = 'Duración de la validez de la inscripción, a partir del momento en que se inscribe el usuario. Si se desactiva, la duración de la inscripción será ilimitada.';
$string['enrolstartdate'] = 'Fecha de inicio';
$string['enrolstartdate_help'] = 'Si está activada, los usuarios solo se podrán inscribir a partir de esta fecha.';
...
$string['event:order:delivered'] = 'Pedido entregado/inscripción creada';
$string['expiredaction'] = 'Acción de vencimiento de la inscripción';
$string['expiredaction_help'] = 'Seleccione la acción que se llevará a cabo cuando caduque la inscripción del usuario. Tenga en cuenta que algunos datos y ajustes del usuario se eliminan del curso al cancelar la inscripción.';
$string['expirymessageenrolledbody'] = 'Estimado {$a->user}:

Esta es una notificación de que su inscripción en el curso \'{$a->course}\' caduca el {$a->timeend}.

Si necesita ayuda, póngase en contacto con {$a->enroller}.';
$string['expirymessageenrolledsubject'] = 'Notificación de vencimiento de la inscripción';
$string['expirymessageenrollerbody'] = 'La inscripción en el curso \'{$a->course}\' caducará dentro del próximo {$a->umbral} para los siguientes usuarios:

{$a->users}

Para ampliar su matrícula, vaya a {$a->extendurl}.';
$string['expirymessageenrollersubject'] = 'Notificación de vencimiento de la inscripción';
...
$string['gwpayments:config'] = 'Configurar inscripción con \'gwpayment\'';
$string['gwpayments:createcoupon'] = 'Crear códigos de cupón para inscripciones con gwpayment';
$string['gwpayments:deletecoupon'] = 'Eliminar códigos de cupón para inscripciones con gwpayment';
$string['gwpayments:editcoupon'] = 'Editar códigos de cupón para inscripciones con gwpayment';
$string['gwpayments:manage'] = 'Gestionar inscripciones con gwpayment';
$string['gwpayments:unenrol'] = 'Bajas de inscripciones con gwpayment';
$string['gwpayments:unenrolself'] = 'Bajas autorealizadas para inscripciones con gwpayment';
...
$string['messageprovider:expiry_notification'] = 'Notificación de expiración de inscripción';
$string['messageprovider:gwpayments_enrolment'] = 'Notificación de inscripción GWPayments';
$string['nocost'] = '¡La inscripción a este curso es gratuita!';
$string['paymentaccount'] = 'Cuenta de pago';
$string['paymentaccount_help'] = 'Las tasas de las inscripciones se abonarán en esta cuenta.';
$string['percentage'] = 'Porcentaje';
$string['percentagemissing'] = 'Se debe indicar el porcentaje';
$string['pluginname'] = 'Inscripción con Pagos';
$string['pluginname_help'] = 'Este plugin permite comprar un curso con los portales de pago principales de Moodle, e incorpora opciones  para aplicar descuentos basados en cupones/vales';
$string['privacy:metadata'] = 'El plugin de inscripción con pago no almacena ningún dato personal.';
$string['promo'] = 'Plugin inscripción con PaymentS para Moodle';
...
{$a}<br /><br />';
$string['purchasedescription'] = 'Inscripción en el curso {$a}';
$string['sendpaymentbutton'] = 'Seleccione el tipo de pago';
$string['status'] = 'Permitir pagos a través de portal';
$string['status_help'] = 'Permitir que por defecto los usuarios utilicen portales de pago para inscribirse en un curso.';
$string['task:defaulttasks'] = 'Tareas predeterminadas';
$string['task:sendexpirynotifications'] = 'La inscripción con PaymentS envía notificaciones de caducidad de tarea';
...
$string['vat'] = 'IVA';
$string['vat_help'] = 'Porcentaje de IVA sobre el costo del curso (nota: el costo del curso incluye el IVA).';
$string['warn:zeropayment'] = 'Nota: al usar códigos de descuento que conducen a un pago final de cero, por ejemplo, cuando utilice un descuento del 100%, debe tener en cuenta que no todas las implementaciones de portales de pago
pueden gestionarlo. Es muy probable que finalmente termine con un error del proveedor de servicios de pago.
Para evitar esto, usted o el administrador de sistemas <i>pueden</i> habilitar la omisión de los portales de pago pagos \'cero\' (a través de la configuración global del plugin). La inscripción se procesará, pero <i>sin</i> una identificación de pago válida (usaremos un valor 0 como identificación de pago).';
