...
/**
 * Strings for component 'competency', language 'es_mx', version '4.4'.
 *
 * @package     competency
 * @category    string
...
$string['errorplanstatus'] = 'Planes de aprendizaje \'{$a}\' estado desconocido';
...
$string['errorusercomptencystatus'] = 'Estado de competencia del usuario \'{$a}\' desconocido';
...
$string['privacy:metadata:usercomp:proficiency'] = 'Si se logró la pericia/dominio/maestría';
