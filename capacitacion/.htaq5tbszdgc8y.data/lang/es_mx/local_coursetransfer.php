...
/**
 * Strings for component 'local_coursetransfer', language 'es_mx', version '4.4'.
 *
...
$string['config_destiny_merge_activities'] = 'Fusionar el curso de respaldo en este curso';
$string['config_destiny_merge_activities_desc'] = 'Las actividades del curso de origen se fusionarán con las del curso de destino.';
$string['config_destiny_remove_activities'] = 'Eliminar el contenido de este curso y luego restaurarlo';
$string['config_destiny_remove_activities_desc'] = 'Todo el contenido del curso de destino se eliminará y se restaurará con el curso de origen.';
$string['config_destiny_remove_enrols'] = 'Eliminar roles e inscripciones actuales';
$string['config_destiny_remove_enrols_desc'] = 'Se eliminarán los roles y las inscripciones de los cursos de destino existentes.';
$string['config_destiny_remove_groups'] = 'Eliminar grupos y agrupaciones actuales';
$string['config_destiny_remove_groups_desc'] = 'Se eliminarán los grupos y agrupaciones de cursos de destino existentes.';
...
$string['coursetransfer:destiny_restore_content_remove'] = 'Eliminar el contenido de este curso y luego restaurarlo';
$string['coursetransfer:destiny_restore_enrol_remove'] = 'Eliminar roles e inscripciones actuales';
$string['coursetransfer:destiny_restore_groups_remove'] = 'Eliminar grupos y agrupaciones actuales';
$string['coursetransfer:destiny_restore_merge'] = 'Fusionar el curso de respaldo en este curso';
...
$string['deleteindestiny'] = 'Quitar en destino';
$string['destiny_category_id_integer'] = 'El ID de la categoría de destino es un número entero';
$string['destiny_category_id_require'] = 'Se requiere la ID de la categoría de destino';
$string['destiny_course_id'] = 'ID del curso de destino';
$string['destiny_course_id_integer'] = 'El ID del curso de destino es un número entero';
$string['destiny_course_id_is_required'] = 'Se requiere el ID del curso de destino: --destiny_course_id=12';
$string['destiny_course_id_isnot_correct'] = 'Para destiny_target=2 no debe haber un curso objetivo, se creará un nuevo curso';
$string['destiny_not_remove_activities_invalid'] = 'Destino No eliminar actividades debe ser una cadena separada por comas tipo matriz: --destiny_not_remove_activities=[3,234,234]';
$string['destiny_remove_enrols_boolean'] = 'El destino Eliminar inscripciones debe ser un valor booleano: --destiny_remove_enrols=false';
$string['destiny_remove_groups_booelan'] = 'El destino Eliminar grupos debe ser un valor booleano: --destiny_remove_groups=false';
$string['destiny_site'] = 'Sitio de destino';
$string['destiny_target_is_incorrect'] = 'El destino es incorrecto, debe tener los valores 2, 3 o 4: --destiny_target=2';
...
$string['log_page_destiny_request'] = 'Petición del destino';
$string['log_page_destiny_target'] = 'Objetivo de destino';
...
$string['setting_destiny_restore_course_max_size_desc'] = 'Límite del tamaño de la copia de seguridad (archivo MBZ) del curso origen a restaurar en MB.';
$string['setting_destiny_sites'] = 'Sitios de destino';
$string['setting_destiny_sites_desc'] = 'Listado de sitios de destino a los que se pueden enviar las copias de seguridad de los cursos. Realizar una prueba para verificar que todo esté configurado correctamente, tanto en destino como en origen.';
$string['setting_destiny_sites_link'] = 'Gestión de sitios de destino';
