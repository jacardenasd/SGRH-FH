...
/**
 * Strings for component 'calendar', language 'es_mx', version '4.4'.
 *
 * @package     calendar
 * @category    string
...
$string['newmonthannouncement'] = 'El calendario ahora está configurado a {$a}.';
$string['nocalendarsubscriptions'] = 'Aun no hay suscripciones a calendarios. ¿Desea usted {$a}';
$string['nocalendarsubscriptionsimportexternal'] = 'Aun no hay suscripciones al calendario. <a href="{$a}">Importar un calendario externo</a>';
