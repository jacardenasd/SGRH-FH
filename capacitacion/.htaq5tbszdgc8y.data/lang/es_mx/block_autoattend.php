...
/**
 * Strings for component 'block_autoattend', language 'es_mx', version '4.4'.
 *
...
$string['attendgpercent'] = 'Tasa de Calificación';
...
$string['attendnpercent'] = 'Tasa de Asistencia';
...
$string['cleanupdb_help'] = 'Eliminar datos de sesiones de los cursos ya eliminados. Los datos de asistencia de sesiones eliminadas también son eliminados al mismo tiempo.<br /> Esta función solamente puede ser ejecutada por un administrador.';
...
$string['deletedb_help'] = 'Eliminar datos de sesiones más antiguas que la fecha especificada. Los datos de asistencia de sesiones eliminadas también son eliminados al mismo tiempo.<br />
Este proceso puede demorar mucho tiempo.<br />
Esta función solamente puede ser ejecutada por un administrador.';
$string['deletedb_info'] = 'Hay <div style="font-weight:bold;">{$a->delnum}</div> datos de sesiones a ser eliminados antes de <div style="font-weight:bold;">{$a->delstr}</div>.';
...
$string['email_teacher_key_html'] = 'La palabra clave de{$a->fullname} [{$a->date} {$a->starttm}-{$a->endtm}] es <div style="font-weight:bold;">{$a->key}</div>';
...
$string['installpairmod'] = '<div style="font-weight:bold;">Por favor instale el Módulo  (mod_autoattendmod)</div>';
$string['instancepairmod'] = '<div style="font-weight:bold;">Por favor cree una instancia del Módulo (mod_autoattendmod) en este Curso</div>';
$string['ip'] = 'IP';
...
$string['noattforuser'] = 'Número asistencias que existen para el usuario';
...
$string['numofattend'] = 'Número de asistentes';
$string['numofdaysabsent'] = 'Número de días ausente';
$string['numofdaysexcused'] = 'Número de días excusado';
$string['numofdayslate'] = 'Número de días tarde';
$string['numofdayspresent'] = 'Número de días presente';
...
$string['settingpairmod'] = '<div style="font-weight:bold;">Configuración de Módulo (mod_autoattedmod)</div>';
