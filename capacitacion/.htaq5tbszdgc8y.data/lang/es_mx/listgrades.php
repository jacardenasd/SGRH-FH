...
/**
 * Strings for component 'listgrades', language 'es_mx', version '4.4'.
 *
 * @package     listgrades
 * @category    string
...
$string['configdisplayoptions'] = 'Seleccionar todas las opciones que deberían estar disponibles; las configuraciones existentes no son modificadas. Mantenga presionada la tecla CTRL para seleccionar varios campos.';
...
$string['page-mod-listgrades-x'] = 'Cualquier página del módulo listgrades';
...
$string['privacy:metadata'] = 'El plugin de recurso Listgrades no almacena ningún dato personal.';
