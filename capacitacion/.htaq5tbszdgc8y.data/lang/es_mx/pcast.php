...
/**
 * Strings for component 'pcast', language 'es_mx', version '4.4'.
 *
 * @package     pcast
 * @category    string
...
$string['backtoepisodes'] = 'Volver a los episodios';
...
$string['episodecommentandrateview'] = 'Comentarios / Calificaciones';
$string['episodecommentview'] = 'Comentando';
$string['episodedeleted'] = 'el episodio {$a} fue eliminado exitosamente';
$string['episoderateview'] = 'Valoraciones';
...
$string['episodeview'] = 'Ver Episodio';
$string['episodeviews'] = 'Vistas de Episodios';
...
$string['subscribepisodes'] = 'Suscribirse a los episodios';
