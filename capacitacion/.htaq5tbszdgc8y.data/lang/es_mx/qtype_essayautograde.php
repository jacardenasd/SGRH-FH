...
/**
 * Strings for component 'qtype_essayautograde', language 'es_mx', version '4.4'.
 *
...
$string['aiassistant'] = 'asistente de IA';
$string['aiassistant_help'] = 'Seleccione el asistente de calificación de IA, si corresponde, que desea utilizar para generar retroalimentaciones y calificaciones preliminares para las entregas de los estudiantes.';
$string['aiassistantnotenabled'] = 'Actualmente no hay asistentes de IA para generar texto habilitados en este sitio Moodle. Solicite a su administrador de Moodle que agregue la configuración para un proveedor de IA (Administración del sitio > IA).';
$string['aipercent'] = 'calificación por IA';
$string['aipercent_help'] = 'Seleccione la contribución porcentual de la calificación de IA a la calificación total de esta pregunta.';
$string['aiprompt'] = 'prompt de IA';
$string['aiprompt_help'] = 'Añadir un prompt apropiado para enviarle a un asistente de IA para obtener retroalimentación y/o calificación para trabajos enviados por estudiantes.';
...
$string['bandtext'] = 'Para {$a->count} o más elementos, otorgar {$a->percent} de la calificación de la pregunta.';
