...
/**
 * Strings for component 'assignfeedback_editpdf', language 'es_mx', version '4.4'.
 *
...
$string['pathtogserror'] = 'La ruta configurada a ghostscript no está puesta correctamente: {$a}';
