...
/**
 * Strings for component 'local_mass_enroll', language 'es_mx', version '4.4'.
 *
...
$string['allowedunenrolmentmethods'] = 'Des-inscripciones extra permitidas';
$string['allowedunenrolmentmethods_help'] = 'Indique los métodos de inscripción predeterminados permitidos que se pueden utilizar para la cancelación de la inscripción masiva.<br/>
Tenga en cuenta que no se puede configurar "manual", ya que es el método predeterminado y siempre se procesará.<br/>
<i>Tenga cuidado con los métodos que selecciona, ya que pueden generar dudas. Por ejemplo, es posible que no desee eliminar las inscripciones que se pagaron (paypal, stripe, classicpay, etc.).</i>';
$string['checknonmanualenrolments'] = '¿Verificar otras inscripciones que no sean manuales?';
$string['checknonmanualenrolments_help'] = 'Cuando está habilitada, se verificarán las asignaciones de roles de métodos de inscripción distintos a los manuales, lo que significa que el rol de destino se puede aplicar desde cualquier plugin de inscripción.
Si el usuario tiene el rol de destino de cualquier plugin de inscripción, se omitirá el procesamiento';
$string['creategroupings'] = 'Crear agrupamiento(s) si fuera necesario';
$string['creategroups'] = 'Crear grupo(s) si fuera necesario';
$string['defaultrole'] = 'Rol predeterminado a asignar';
$string['defaultrole_help'] = 'Proporcionar el rol predeterminado para asignar cuando no esté presente en el CSV';
$string['email_sent'] = 'Email enviado a {$a}';
$string['enableextraunenrolmentplugins'] = '¿Permitir plugins de cancelación de inscripción adicionales?';
$string['enableextraunenrolmentplugins_help'] = 'Utilice esto si desea permitir la cancelación de la inscripción de otros plugins que no sean "manuales".';
$string['enablemassenrol'] = '¿Permitir inscripciones masivas desde el menú de participantes del curso';
$string['enablemassenrol_help'] = 'Marque esta opción para permitir la extensión de la inscripción masiva en el árbol de administración del curso.
Tenga en cuenta que el enlace ahora se puede encontrar en el menú terciario en la sección "Participantes".';
$string['enablemassunenrol'] = '¿Permitir la cancelación masiva de inscripciones desde el menú de participantes del curso?';
$string['enablemassunenrol_help'] = 'Marque esta opción para permitir la extensión de la cancelación masiva de la inscripción en el árbol de administración del curso.
Tenga en cuenta que el enlace ahora se puede encontrar en el menú terciario en la sección "Participantes".';
$string['enclosure'] = 'Adjunto CSV';
$string['enroll'] = 'Inscribirlos a mi curso';
$string['error'] = 'Error';
$string['event:massenrolcreated'] = 'Inscripción masiva creada';
$string['event:massunenrolcreated'] = 'Des-inscripción masiva creada';
...
$string['im:and_added_g'] = 'y añadido al grupo Moodle {$a}';
$string['im:enrolled_ok'] = '{$a} inscrito(s)';
$string['im:err_opening_file'] = 'error al abrir archivo {$a}';
$string['im:error_add_g_grp'] = 'error al añadir grupo  {$a->group} al agrupamiento {$a->grouping}';
$string['im:error_add_grp'] = 'error al añadir agrupamiento {$a->grouping} al curso {$a->courseid}';
$string['im:error_addg'] = 'error al añadir grupo  {$a->group} al curso {$a->courseid}';
...
$string['im:nonassignablerole'] = 'El rol {$a} no se puede asignar en este contexto';
...
$string['mapping:column'] = 'Columna {$a}';
...
$string['other'] = 'Otras configuraciones';
$string['pluginname'] = 'Inscripciones masivas';
$string['privacy:metadata'] = 'El plugin local Mass Enrol no almacena ningún dato personal';
$string['process:massenrol:success'] = 'Inscripción masiva exitosa';
$string['process:massunenrol:success'] = 'Des-inscripción masiva exitosa';
$string['role'] = 'Rol';
