...
/**
 * Strings for component 'organizer', language 'es_mx', version '4.4'.
 *
 * @package     organizer
 * @category    string
...
$string['btn_comment'] = 'Editar su comentario';
...
$string['cfg_limitedwidth'] = 'Área de contenido más pequeña';
$string['cfg_limitedwidth_desc'] = 'Usar áreas más pequeñas de contenido de Moodle 4.x en organizador. Lo predeterminado de Moodle es usado, pero puede ser estirado por entradas de tabla largas.';
...
$string['err_norecipients'] = '¡No se seleccionaron destinatarios!';
...
$string['id'] = 'ID';
$string['img_title_due'] = 'El espacio-tiempo puede ser reservado';
$string['img_title_evaluated'] = 'El espacio está evaluado';
$string['img_title_full'] = 'El espacio-tiempo está lleno';
...
"Usar grupos existentes": Un único miembro del grupo reserva un espacio-tiempo para el grupo.
...
$string['message_info_appointment_deleted'] = 'La reservación fue eliminada. El participante ha sido notificado.';
...
$string['mymoodle_reg_slot'] = 'Usted ya ha reservado {$a->booked}  espacio-tiempos y por eso ha alcanzado el mínimo de {$a->slotsmin} reservaciones.';
$string['mymoodle_reg_slot_group'] = '{$a->booked}Su grupo {$a->groupname} ha reservado {a->booked} espacio-tiempos y por lo tanto alcanzó el mínimo de {$a->slotsmin} reservaciones.';
...
$string['nolocationplaceholder'] = '[PENDIENTEdeDEFINIR]';
...
$string['organizer:deleteappointments'] = 'Eliminar resevaciones';
...
$string['places_inqueue_withposition'] = 'Usted está en {$a->queueposition} posición en lista de espera';
...
$string['recipientname'] = '_nombre del destinatario_';
...
$string['select_all_entries'] = 'Seleccionar todas las entradas';
...
$string['synchronizegroupmembers'] = 'Sincronizar miembros del grupo';
$string['synchronizegroupmembers_help'] = 'Si cambian los miembros del grupo, los cambios serán puestos en espacios reservados.';
...
$string['userslotsdailymax'] = 'Máximo de espacios por participante o grupo por día';
$string['userslotsdailymax_help'] = 'Cantidad de espacios que un grupo o participante tiene permitido reservar por día. \'0\' significa que no hay límite diario.';
