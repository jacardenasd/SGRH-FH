...
/**
 * Strings for component 'block_deft', language 'es_mx', version '4.4'.
 *
 * @package     block_deft
 * @category    string
...
$string['appid_desc'] = 'Este servidor Jitsi debe estar protegido para que solo los participantes autorizados por la actividad puedan participar. El administrador del servidor debe configurar un ID de aplicación y una clave secreta para usar aquí. Consulte la <a href="https://jitsi.github.io/handbook/docs/devops-guide/devops-guide-quickstart/">documentación de Jitsi</a> para alojarlo usted mismo.';
...
$string['configuremanually'] = 'El proceso de registro automático ha fallado por algún motivo. La herramienta LTI debe configurarse manualmente. Contacte a los desarrolladores para informar de esto y obtener las URL para la configuración manual.';
...
$string['deftbridge'] = 'Servidor multimedia alojado Deftly';
$string['deftsettings'] = 'Configuraciones del servidor alojado Deftly';
$string['deftsettings_desc'] = 'Si se selecciona el servidor Deftly alojado para actualizar el contenido, se debe habilitar el acceso a continuación.';
...
$string['enableupdating_desc'] = 'Seleccione el tipo de servidor que desea usar. También deberá completar la sección correspondiente al tipo de servidor seleccionado. Si no selecciona ninguno, el contenido solo se actualizará al recargar la página.';
...
$string['jitsibridge'] = 'Servidor Jitsy alojado localmente';
$string['jitsisettings'] = 'Configuraciones de Jitsi';
$string['jitsisettings_desc'] = 'Si se selecciona el servidor multimedia Jitsi auto hospedado localmente para actualizar contenido o para el puente de audio/video, entonces esta sección debe completarse para usar ese servidor.';
$string['join'] = 'Unirse';
...
$string['noisesuppression'] = 'Supresión de ruido';
$string['noisesuppression_desc'] = 'Reduce el ruido que no suena como voz. Esto puede distorsionar la música u otros sonidos.';
...
$string['openinblock'] = 'Abrir en bloque';
...
$string['secret_desc'] = 'El administrador del servidor Jitsi debería proporcionar el secreto para acceder al  servidor';
$string['server'] = 'Servidor';
$string['server_desc'] = 'El nombre de host que el servidor Jitsi utilizará para la reunión';
...
$string['updatesettings_desc'] = 'Controlar la forma en la que el contenido es actualizado en el navegado';
$string['venue'] = 'Evento';
...
$string['venuesettings_desc'] = 'Parámetros usados para audio y video para el trabajo en el Lugar.';
