...
/**
 * Strings for component 'tool_uploaduser', language 'es_mx', version '4.4'.
 *
...
$string['invaliduserdatavalues'] = 'Datos incorrectos ({$a->values}) encontrados para usuario {$a->username}. Estos datos han sido corregidos o eliminados.';
