...
/**
 * Strings for component 'format_remuiformat', language 'es_mx', version '4.4'.
 *
...
$string['editmodeinfo'] = 'Cuando esté editando, el curso cambia al formato de Moodle para una edición más fácil. Regresará al .formato de curso Edwiser cuando usted desactive el modo de edición.';
...
$string['headeroverlayopacity'] = 'Cambiar la opacidad el sobrepuesto del encabezado';
$string['headeroverlayopacity_help'] = 'El valor predeterminado ya está configurado a \'100\'. Para ajustar la opacidad, por favor ingrese un valor entre 0 y 100';
$string['hiddensections'] = 'Secciones ocultas';
$string['hiddensections_help'] = 'Las secciones ocultas se pueden mostrar a los estudiantes como "no disponibles" en la página del curso o mantenerlas completamente ocultas.';
...
$string['plugin_description'] = 'Los cursos son presentados como listas colapsables O como tarjetas de secciones con un diseño responsivo para una mejor navegación.';
...
$string['sectiontitlesummarymaxlength'] = 'Configurar la longitud máxima de la descripción de secciones/actividades.';
$string['sectiontitlesummarymaxlength_help'] = 'Establezca el número máximo de caracteres que se mostrarán en las descripciones de secciones y actividades en la tarjeta.';
