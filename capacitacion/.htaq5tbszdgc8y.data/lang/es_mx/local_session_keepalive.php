...
/**
 * Strings for component 'local_session_keepalive', language 'es_mx', version '4.4'.
 *
...
$string['setting_keepalivetimeoutwarningnote'] = 'Por favor tenga en cuenta: El núcleo de Moodle muestra una ventana emergente al usuario antes de que se agote el tiempo de sesión para que pueda extenderla. El tiempo de espera también se puede configurar en la página {$a->page} mediante la configuración sessiontimeoutwarning. Este plugin puede coexistir perfectamente con esta funcionalidad principal, siempre que se asegure de configurar esta configuración a un valor considerablemente menor que el tiempo de espera configurado (actualmente establecido en {$a->minutes} minutos).';
