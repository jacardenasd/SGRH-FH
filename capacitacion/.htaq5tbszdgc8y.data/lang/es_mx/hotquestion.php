...
/**
 * Strings for component 'hotquestion', language 'es_mx', version '4.4'.
 *
 * @package     hotquestion
 * @category    string
...
$string['crontask'] = 'Procesamiento en segundo plano para módulo HotQuestion';
...
$string['evententriesviewed'] = 'Preguntas vistas';
$string['evententryupdated'] = 'Pregunta actualizada';
...
$string['privacy:metadata:hotquestion_grades'] = 'Datos de calificación para instancias de hotquestion';
$string['privacy:metadata:hotquestion_grades:rawrating'] = 'Valoración cruda';
$string['privacy:metadata:hotquestion_grades:userid'] = 'La ID del usuario que publicó esta calificación.';
