...
/**
 * Strings for component 'block_configurable_reports', language 'es_mx', version '4.4'.
 *
...
$string['allowedsqlusers'] = 'reporte usuarios SQL';
$string['allowedsqlusersinfo'] = 'Si desea que solo ciertos usuarios administradores administren informes SQL, agregue una lista de nombres de usuario separados por comas. También deben tener la función block/configurable_reports:managesqlreports.';
...
$string['checksql_execution_details'] = 'Al permitir la ejecución de código SQL, existe un posible problema de seguridad si los usuarios agregan código arbitrario. La ejecución de código SQL debe deshabilitarse para permitir únicamente consultas SQL para leer/recuperar datos. La ejecución de SQL puede deshabilitarse en el archivo config.php estableciendo $CFG->block_configurable_reports_enable_sql_execution a 0.';
...
$string['csvdelimiterinfo'] = 'Delimitador CSV: "dos puntos" para ":", "coma" para ",", punto y coma para ";", "tabulación" para "\\t" y "cfg" para el carácter configurado en "CFG->CSV_DELIMITER" del archivo config.php.';
...
$string['description_help'] = 'Texto utilizado para describir el filtro que se mostrará en el resumen en la página de filtros.';
$string['direction'] = 'Instruccion';
$string['disabled'] = 'Deshabilitado';
$string['displayglobalreports'] = 'Mostrar reportes globales';
$string['displayprintbutton'] = 'Botón Imprimir';
$string['displayprintbuttondescription'] = 'Mostrar el botón Imprimir en el fondo del reporte';
$string['displayreportslist'] = 'Mostrar la lista de reportes en el cuerpo del bloque';
$string['displaytotalrecords'] = 'Total de Registros';
$string['displaytotalrecordsdescription'] = 'Muestra el número total de resultados en el reporte';
...
$string['embedlink'] = 'Incrustar enlace';
$string['embedlinkdescription'] = 'Usted puede copiar este enlace para incrustar el reporte en un bloque HTML';
$string['embedoptions'] = 'Opciones para incrustar';
...
$string['export_slk'] = 'Exportar en formato SYLK';
...
$string['generalcolorpalette_help'] = 'Códigos de color hexadecimales para uso general en el gráfico de pastel. Los códigos podrían estar separados por nuevas líneas en el orden en el que usted quiera que sean usadas en el gráfico de pastel.';
...
$string['idnumber_help'] = 'Usado para diferenciar entre filtros del mismo tipo. Sensible a minúsculas/MAYÚSCULAS.
Ejemplo de uso: %%FILTER_SEARCHTEXT_username:u.username:~%%';
...
$string['reportlimitinfo'] = 'Limite el número de filas que son mostradas en la tabla del reporte (El valor por defecto es de 5000 filas). Lo mejor es tener un cierto límite, para que los usuarios no sobrecarguen el motor de la BasedeDatos)';
...
$string['reporttableuiinfo'] = 'Mostrar la tabla del reporte como: Tabla HTML simple desplazable, jQuery con ordenamiento de columnas o biblioteca DataTables JS (ordenamiento de columnas, encabezado fijo, búsqueda, paginación, etc.)';
...
$string['value_fields_help'] = 'Campos que deben representarse en el gráfico. Pulse Ctrl+clic (Cmd+clic en Mac) para seleccionar varios.
Si selecciona el campo Etiqueta o un campo con valores no numéricos, se ignorará.';
