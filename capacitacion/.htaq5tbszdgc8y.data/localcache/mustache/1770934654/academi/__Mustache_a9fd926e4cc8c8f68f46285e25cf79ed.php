...
class __Mustache_a9fd926e4cc8c8f68f46285e25cf79ed extends Mustache_Template
{
...
';
        $value = $context->find('themestyleheader');
        $buffer .= $this->section9e0d5a19791c510e9f039da6902550f6($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '            ';
        $value = $context->find('themestyleheader');
...
';
    ...
    private function section9e0d5a19791c510e9f039da6902550f6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
                <nav class="nav navbar-nav hidden-md-down address-head">
                    <span class="site-name-header" style="font-size: 24px; font-weight: bold; color: #ffffff; letter-spacing: 0.5px;">
                        Academia de Talento
                    </span>
                </nav>
            ';
...
';
                $buffer .= $indent . '                    <span class="site-name-header" style="font-size: 24px; font-weight: bold; color: #ffffff; letter-spacing: 0.5px;">
';
