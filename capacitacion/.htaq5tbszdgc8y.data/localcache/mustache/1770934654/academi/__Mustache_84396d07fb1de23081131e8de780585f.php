...
class __Mustache_84396d07fb1de23081131e8de780585f extends Mustache_Template
{
...
';
        $value = $context->find('themestyleheader');
        $buffer .= $this->sectionC892a23227f2d97ab3e731139a7cb489($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '            ';
        $value = $context->find('themestyleheader');
...
';
    ...
    private function sectionC892a23227f2d97ab3e731139a7cb489(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
                <nav class="nav navbar-nav hidden-md-down address-head">
                    <span class="site-name-header" style="font-size: 24px; font-weight: bold; color: #2c5aa0; letter-spacing: 0.5px;">
                        Academia de Talento
                    </span>
                </nav>
            ';
...
';
                $buffer .= $indent . '                    <span class="site-name-header" style="font-size: 24px; font-weight: bold; color: #2c5aa0; letter-spacing: 0.5px;">
';
                $buffer .= $indent . '                        Academia de Talento
';
                $buffer .= $indent . '                    </span>
';
                $buffer .= $indent . '                </nav>
