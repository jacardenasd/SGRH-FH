...
class __Mustache_5d69c2205f62b0b9ac389cef592ba58e extends Mustache_Template
{
...
';
        $value = $context->find('themestyleheader');
        $buffer .= $this->section4ce70a4c57dc8ada27b99500bba90f1b($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '            ';
        $value = $context->find('themestyleheader');
...
';
    ...
    private function section4ce70a4c57dc8ada27b99500bba90f1b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
                <nav class="nav navbar-nav hidden-md-down address-head">
                    <span class="site-name-header">Academia de Talento</span>
                </nav>
            ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
...
';
                $buffer .= $indent . '                    <span class="site-name-header">Academia de Talento</span>
';
                $buffer .= $indent . '                </nav>
';
                $context->pop();
