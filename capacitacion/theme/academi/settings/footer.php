...
$name = 'theme_academi/emailname';

$title = get_string('emailname', 'theme_academi');
...
$name = 'theme_academi/emailid2';

$title = get_string('emailid2', 'theme_academi');
...
$name = 'theme_academi/emailname2';

$title = get_string('emailname2', 'theme_academi');
