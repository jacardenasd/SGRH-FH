-- =====================================================
-- Migración: Módulo de Trámite de Pago a Proveedores
-- Fecha: 2026-02-11
...
CREATE TABLE IF NOT EXISTS proveedores (
    ...
    categoria VARCHAR(100) DEFAULT NULL COMMENT 'Categoría del proveedor: tecnología, limpieza, papelería, etc.',
...
-- Descripción: Solicitudes de pago a proveedores
-- =====================================================
CREATE TABLE IF NOT EXISTS pago_proveedores (
    ...
    folio VARCHAR(50) NOT NULL COMMENT 'Folio único del trámite',
    fecha_solicitud DATE NOT NULL,
    fecha_limite_pago DATE DEFAULT NULL,
    
    -- Concepto y montos
    concepto TEXT NOT NULL COMMENT 'Descripción del servicio/bien',
    ...
    unidad_id INT UNSIGNED DEFAULT NULL COMMENT 'Área que solicita el pago',
    adscripcion_id INT UNSIGNED DEFAULT NULL COMMENT 'Departamento solicitante',
    ...
    referencia_pago VARCHAR(100) DEFAULT NULL COMMENT 'Número de transferencia/cheque',
...
COMMENT='Solicitudes de pago a proveedores';


-- =====================================================
-- Tabla: pago_proveedores_documentos
-- Descripción: Documentos adjuntos a solicitudes
-- =====================================================
...
COMMENT='Documentos adjuntos a solicitudes de pago';


-- =====================================================
-- Tabla: pago_proveedores_historial
-- Descripción: Bitácora de cambios de estado
-- =====================================================
...
COMMENT='Historial de cambios de estado en solicitudes';
...
VALUES 
    ('pagos_proveedores.admin', 'Administración completa de Pagos a Proveedores (CRUD de proveedores y trámites)', 'Administración'),
...
-- Asignar permiso admin a rol de Administrador
...
-- Asignar permiso de autorización a Admin Organización
INSERT IGNORE INTO rol_permisos (rol_id, permiso_id)
SELECT r.rol_id, p.permiso_id
FROM roles r
CROSS JOIN permisos p
...
-- =====================================================
-- Vista auxiliar: Resumen de pagos por proveedor
-- =====================================================
...
INSERT INTO proveedores (empresa_id, razon_social, rfc, nombre_comercial, telefono, email, tipo_proveedor, categoria, estatus)
VALUES 
    (1, 'Tecnología y Soluciones SA de CV', 'TYS980101ABC', 'TechSol', '5551234567', 'contacto@techsol.com', 'servicios', 'tecnología', 1),
    (1, 'Papelería El Lápiz Feliz SA', 'PLF850215XYZ', 'El Lápiz Feliz', '5559876543', 'ventas@lapizfeliz.com', 'bienes', 'papelería', 1);

-- Ejemplo de solicitud de pago
INSERT INTO pago_proveedores (empresa_id, proveedor_id, folio, fecha_solicitud, concepto, subtotal, iva, total, estatus, unidad_id)
VALUES 
    (1, 1, 'PAG-2026-001', '2026-02-11', 'Servicio de mantenimiento de servidores', 10000.00, 1600.00, 11600.00, 'pendiente', 1);
*/
